...
main(int argc, char *argv[])
{
  ...
  49:	68 29 06 00 00       	push   $0x629
  4e:	6a 00                	push   $0x0
  50:	e8 05 03 00 00       	call   35a <printf>
  ...
  67:	68 14 06 00 00       	push   $0x614
  6c:	6a 00                	push   $0x0
  6e:	e8 e7 02 00 00       	call   35a <printf>
        for (int i = 0; i < numframes; i++)
  73:	83 c3 01             	add    $0x1,%ebx
  76:	83 c4 10             	add    $0x10,%esp
  79:	81 fb 0f 27 00 00    	cmp    $0x270f,%ebx
