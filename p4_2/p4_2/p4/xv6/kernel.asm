...
80100506:	e8 7b 4c 00 00       	call   80105186 <uartputc>
...
8010051f:	e8 62 4c 00 00       	call   80105186 <uartputc>
80100524:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010052b:	e8 56 4c 00 00       	call   80105186 <uartputc>
80100530:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100537:	e8 4a 4c 00 00       	call   80105186 <uartputc>
...
80100970:	75 b2                	jne    80100924 <exec+0x52>
  if((pgdir = setupkvm()) == 0)
80100972:	e8 cf 59 00 00       	call   80106346 <setupkvm>
...
80100a06:	e8 e1 57 00 00       	call   801061ec <allocuvm>
...
80100a38:	e8 7d 56 00 00       	call   801060ba <loaduvm>
...
80100a74:	e8 73 57 00 00       	call   801061ec <allocuvm>
...
80100a9d:	e8 34 58 00 00       	call   801062d6 <freevm>
...
80100abc:	e8 0a 59 00 00       	call   801063cb <clearpteu>
...
80100b06:	e8 0e 5a 00 00       	call   80106519 <copyout>
...
80100b66:	e8 ae 59 00 00       	call   80106519 <copyout>
...
80100bd1:	e8 63 53 00 00       	call   80105f39 <switchuvm>
  freevm(oldpgdir);
80100bd6:	89 1c 24             	mov    %ebx,(%esp)
80100bd9:	e8 f8 56 00 00       	call   801062d6 <freevm>
  return 0;
...
80102a2d:	e8 ec 24 00 00       	call   80104f1e <idtinit>
...
80102a4d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a50:	e8 d2 34 00 00       	call   80105f27 <switchkvm>
  seginit();
80102a55:	e8 81 33 00 00       	call   80105ddb <seginit>
  lapicinit();
...
80102aa7:	e8 20 27 00 00       	call   801051cc <uartinit>
  pinit();         // process table
80102aac:	e8 ba 06 00 00       	call   8010316b <pinit>
  tvinit();        // trap vectors
80102ab1:	e8 b7 23 00 00       	call   80104e6d <tvinit>
  binit();         // buffer cache
...
801030e7:	c7 80 b0 0f 00 00 62 	movl   $0x80104e62,0xfb0(%eax)
801030ee:	4e 10 80 
  sp -= sizeof *p->context;
...
80103233:	e8 0e 31 00 00       	call   80106346 <setupkvm>
...
80103251:	e8 fb 2d 00 00       	call   80106051 <inituvm>
  p->sz = PGSIZE;
...
8010332a:	e8 2b 2e 00 00       	call   8010615a <deallocuvm>
...
80103347:	e8 a0 2e 00 00       	call   801061ec <allocuvm>
...
80103359:	e8 db 2b 00 00       	call   80105f39 <switchuvm>
  return 0;
...
8010339e:	e8 54 30 00 00       	call   801063f7 <copyuvm>
...
801034b1:	e8 83 2a 00 00       	call   80105f39 <switchuvm>
      p->state = RUNNING;
...
801034c7:	e8 c1 09 00 00       	call   80103e8d <swtch>
      switchkvm();
801034cc:	e8 56 2a 00 00       	call   80105f27 <switchkvm>
      c->proc = 0;
...
8010377a:	e8 57 2b 00 00       	call   801062d6 <freevm>
        p->pid = 0;
...
80104e1c:	83 ec 1c             	sub    $0x1c,%esp
  struct pstat* p;
  if (argptr(0, (void*)&p, sizeof(struct pstat*)) < 0) {
80104e1f:	6a 04                	push   $0x4
80104e21:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104e24:	50                   	push   %eax
80104e25:	6a 00                	push   $0x0
80104e27:	e8 1a f1 ff ff       	call   80103f46 <argptr>
80104e2c:	83 c4 10             	add    $0x10,%esp
80104e2f:	85 c0                	test   %eax,%eax
80104e31:	78 10                	js     80104e43 <sys_getpinfo+0x2a>
    return -1;
  }
  return getpinfo(p);
80104e33:	83 ec 0c             	sub    $0xc,%esp
80104e36:	ff 75 f4             	pushl  -0xc(%ebp)
80104e39:	e8 78 eb ff ff       	call   801039b6 <getpinfo>
...
80104e48:	eb f7                	jmp    80104e41 <sys_getpinfo+0x28>
...
80104e4b:	06                   	push   %es
  pushl %fs
80104e4c:	0f a0                	push   %fs
  pushl %gs
80104e4e:	0f a8                	push   %gs
  pushal
80104e50:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104e51:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104e55:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104e57:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104e59:	54                   	push   %esp
  call trap
80104e5a:	e8 e3 00 00 00       	call   80104f42 <trap>
  addl $4, %esp
80104e5f:	83 c4 04             	add    $0x4,%esp
...
80104e62:	61                   	popa   
  popl %gs
80104e63:	0f a9                	pop    %gs
  popl %fs
80104e65:	0f a1                	pop    %fs
  popl %es
80104e67:	07                   	pop    %es
  popl %ds
80104e68:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104e69:	83 c4 08             	add    $0x8,%esp
  iret
80104e6c:	cf                   	iret   
...
80104e70:	83 ec 08             	sub    $0x8,%esp
  ...
  for(i = 0; i < 256; i++)
80104e73:	b8 00 00 00 00       	mov    $0x0,%eax
80104e78:	eb 4a                	jmp    80104ec4 <tvinit+0x57>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104e7a:	8b 0c 85 08 90 10 80 	mov    -0x7fef6ff8(,%eax,4),%ecx
80104e81:	66 89 0c c5 a0 3e 11 	mov    %cx,-0x7feec160(,%eax,8)
80104e88:	80 
80104e89:	66 c7 04 c5 a2 3e 11 	movw   $0x8,-0x7feec15e(,%eax,8)
80104e90:	80 08 00 
80104e93:	c6 04 c5 a4 3e 11 80 	movb   $0x0,-0x7feec15c(,%eax,8)
80104e9a:	00 
80104e9b:	0f b6 14 c5 a5 3e 11 	movzbl -0x7feec15b(,%eax,8),%edx
80104ea2:	80 
80104ea3:	83 e2 f0             	and    $0xfffffff0,%edx
80104ea6:	83 ca 0e             	or     $0xe,%edx
80104ea9:	83 e2 8f             	and    $0xffffff8f,%edx
80104eac:	83 ca 80             	or     $0xffffff80,%edx
80104eaf:	88 14 c5 a5 3e 11 80 	mov    %dl,-0x7feec15b(,%eax,8)
80104eb6:	c1 e9 10             	shr    $0x10,%ecx
80104eb9:	66 89 0c c5 a6 3e 11 	mov    %cx,-0x7feec15a(,%eax,8)
80104ec0:	80 
  for(i = 0; i < 256; i++)
80104ec1:	83 c0 01             	add    $0x1,%eax
80104ec4:	3d ff 00 00 00       	cmp    $0xff,%eax
80104ec9:	7e af                	jle    80104e7a <tvinit+0xd>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104ecb:	8b 15 08 91 10 80    	mov    0x80109108,%edx
80104ed1:	66 89 15 a0 40 11 80 	mov    %dx,0x801140a0
80104ed8:	66 c7 05 a2 40 11 80 	movw   $0x8,0x801140a2
80104edf:	08 00 
80104ee1:	c6 05 a4 40 11 80 00 	movb   $0x0,0x801140a4
80104ee8:	0f b6 05 a5 40 11 80 	movzbl 0x801140a5,%eax
80104eef:	83 c8 0f             	or     $0xf,%eax
80104ef2:	83 e0 ef             	and    $0xffffffef,%eax
80104ef5:	83 c8 e0             	or     $0xffffffe0,%eax
80104ef8:	a2 a5 40 11 80       	mov    %al,0x801140a5
80104efd:	c1 ea 10             	shr    $0x10,%edx
80104f00:	66 89 15 a6 40 11 80 	mov    %dx,0x801140a6

  initlock(&tickslock, "time");
80104f07:	83 ec 08             	sub    $0x8,%esp
80104f0a:	68 69 6d 10 80       	push   $0x80106d69
80104f0f:	68 60 3e 11 80       	push   $0x80113e60
80104f14:	e8 d2 eb ff ff       	call   80103aeb <initlock>
}
...
80104f21:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80104f24:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104f2a:	b8 a0 3e 11 80       	mov    $0x80113ea0,%eax
80104f2f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80104f33:	c1 e8 10             	shr    $0x10,%eax
80104f36:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80104f3a:	8d 45 fa             	lea    -0x6(%ebp),%eax
80104f3d:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80104f40:	c9                   	leave  
80104f41:	c3                   	ret    
...
80104f48:	83 ec 1c             	sub    $0x1c,%esp
80104f4b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80104f4e:	8b 43 30             	mov    0x30(%ebx),%eax
80104f51:	83 f8 40             	cmp    $0x40,%eax
80104f54:	74 13                	je     80104f69 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104f56:	83 e8 20             	sub    $0x20,%eax
80104f59:	83 f8 1f             	cmp    $0x1f,%eax
80104f5c:	0f 87 3a 01 00 00    	ja     8010509c <trap+0x15a>
80104f62:	ff 24 85 10 6e 10 80 	jmp    *-0x7fef91f0(,%eax,4)
    if(myproc()->killed)
80104f69:	e8 8e e2 ff ff       	call   801031fc <myproc>
80104f6e:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f72:	75 1f                	jne    80104f93 <trap+0x51>
    myproc()->tf = tf;
80104f74:	e8 83 e2 ff ff       	call   801031fc <myproc>
80104f79:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80104f7c:	e8 60 f0 ff ff       	call   80103fe1 <syscall>
    if(myproc()->killed)
80104f81:	e8 76 e2 ff ff       	call   801031fc <myproc>
80104f86:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f8a:	74 7e                	je     8010500a <trap+0xc8>
      exit();
80104f8c:	e8 1a e6 ff ff       	call   801035ab <exit>
80104f91:	eb 77                	jmp    8010500a <trap+0xc8>
      exit();
80104f93:	e8 13 e6 ff ff       	call   801035ab <exit>
80104f98:	eb da                	jmp    80104f74 <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80104f9a:	e8 42 e2 ff ff       	call   801031e1 <cpuid>
80104f9f:	85 c0                	test   %eax,%eax
80104fa1:	74 6f                	je     80105012 <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80104fa3:	e8 f1 d3 ff ff       	call   80102399 <lapiceoi>
  }
...
80104fa8:	e8 4f e2 ff ff       	call   801031fc <myproc>
80104fad:	85 c0                	test   %eax,%eax
80104faf:	74 1c                	je     80104fcd <trap+0x8b>
80104fb1:	e8 46 e2 ff ff       	call   801031fc <myproc>
80104fb6:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104fba:	74 11                	je     80104fcd <trap+0x8b>
80104fbc:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104fc0:	83 e0 03             	and    $0x3,%eax
80104fc3:	66 83 f8 03          	cmp    $0x3,%ax
80104fc7:	0f 84 62 01 00 00    	je     8010512f <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80104fcd:	e8 2a e2 ff ff       	call   801031fc <myproc>
80104fd2:	85 c0                	test   %eax,%eax
80104fd4:	74 0f                	je     80104fe5 <trap+0xa3>
80104fd6:	e8 21 e2 ff ff       	call   801031fc <myproc>
80104fdb:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104fdf:	0f 84 54 01 00 00    	je     80105139 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80104fe5:	e8 12 e2 ff ff       	call   801031fc <myproc>
80104fea:	85 c0                	test   %eax,%eax
80104fec:	74 1c                	je     8010500a <trap+0xc8>
80104fee:	e8 09 e2 ff ff       	call   801031fc <myproc>
80104ff3:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ff7:	74 11                	je     8010500a <trap+0xc8>
80104ff9:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104ffd:	83 e0 03             	and    $0x3,%eax
80105000:	66 83 f8 03          	cmp    $0x3,%ax
80105004:	0f 84 43 01 00 00    	je     8010514d <trap+0x20b>
    exit();
}
...
80105015:	68 60 3e 11 80       	push   $0x80113e60
8010501a:	e8 08 ec ff ff       	call   80103c27 <acquire>
      ticks++;
8010501f:	83 05 a0 46 11 80 01 	addl   $0x1,0x801146a0
      wakeup(&ticks);
80105026:	c7 04 24 a0 46 11 80 	movl   $0x801146a0,(%esp)
8010502d:	e8 dc e7 ff ff       	call   8010380e <wakeup>
      release(&tickslock);
80105032:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
80105039:	e8 4e ec ff ff       	call   80103c8c <release>
8010503e:	83 c4 10             	add    $0x10,%esp
80105041:	e9 5d ff ff ff       	jmp    80104fa3 <trap+0x61>
    ideintr();
80105046:	e8 28 cd ff ff       	call   80101d73 <ideintr>
    lapiceoi();
8010504b:	e8 49 d3 ff ff       	call   80102399 <lapiceoi>
    break;
80105050:	e9 53 ff ff ff       	jmp    80104fa8 <trap+0x66>
    kbdintr();
80105055:	e8 83 d1 ff ff       	call   801021dd <kbdintr>
    lapiceoi();
8010505a:	e8 3a d3 ff ff       	call   80102399 <lapiceoi>
    break;
8010505f:	e9 44 ff ff ff       	jmp    80104fa8 <trap+0x66>
    uartintr();
80105064:	e8 05 02 00 00       	call   8010526e <uartintr>
    lapiceoi();
80105069:	e8 2b d3 ff ff       	call   80102399 <lapiceoi>
    break;
8010506e:	e9 35 ff ff ff       	jmp    80104fa8 <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105073:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80105076:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010507a:	e8 62 e1 ff ff       	call   801031e1 <cpuid>
8010507f:	57                   	push   %edi
80105080:	0f b7 f6             	movzwl %si,%esi
80105083:	56                   	push   %esi
80105084:	50                   	push   %eax
80105085:	68 74 6d 10 80       	push   $0x80106d74
8010508a:	e8 7c b5 ff ff       	call   8010060b <cprintf>
    lapiceoi();
8010508f:	e8 05 d3 ff ff       	call   80102399 <lapiceoi>
    break;
80105094:	83 c4 10             	add    $0x10,%esp
80105097:	e9 0c ff ff ff       	jmp    80104fa8 <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
8010509c:	e8 5b e1 ff ff       	call   801031fc <myproc>
801050a1:	85 c0                	test   %eax,%eax
801050a3:	74 5f                	je     80105104 <trap+0x1c2>
801050a5:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801050a9:	74 59                	je     80105104 <trap+0x1c2>
...
801050ab:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801050ae:	8b 43 38             	mov    0x38(%ebx),%eax
801050b1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801050b4:	e8 28 e1 ff ff       	call   801031e1 <cpuid>
801050b9:	89 45 e0             	mov    %eax,-0x20(%ebp)
801050bc:	8b 53 34             	mov    0x34(%ebx),%edx
801050bf:	89 55 dc             	mov    %edx,-0x24(%ebp)
801050c2:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
801050c5:	e8 32 e1 ff ff       	call   801031fc <myproc>
801050ca:	8d 48 6c             	lea    0x6c(%eax),%ecx
801050cd:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801050d0:	e8 27 e1 ff ff       	call   801031fc <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801050d5:	57                   	push   %edi
801050d6:	ff 75 e4             	pushl  -0x1c(%ebp)
801050d9:	ff 75 e0             	pushl  -0x20(%ebp)
801050dc:	ff 75 dc             	pushl  -0x24(%ebp)
801050df:	56                   	push   %esi
801050e0:	ff 75 d8             	pushl  -0x28(%ebp)
801050e3:	ff 70 10             	pushl  0x10(%eax)
801050e6:	68 cc 6d 10 80       	push   $0x80106dcc
801050eb:	e8 1b b5 ff ff       	call   8010060b <cprintf>
    myproc()->killed = 1;
801050f0:	83 c4 20             	add    $0x20,%esp
801050f3:	e8 04 e1 ff ff       	call   801031fc <myproc>
801050f8:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801050ff:	e9 a4 fe ff ff       	jmp    80104fa8 <trap+0x66>
80105104:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105107:	8b 73 38             	mov    0x38(%ebx),%esi
8010510a:	e8 d2 e0 ff ff       	call   801031e1 <cpuid>
8010510f:	83 ec 0c             	sub    $0xc,%esp
80105112:	57                   	push   %edi
80105113:	56                   	push   %esi
80105114:	50                   	push   %eax
80105115:	ff 73 30             	pushl  0x30(%ebx)
80105118:	68 98 6d 10 80       	push   $0x80106d98
8010511d:	e8 e9 b4 ff ff       	call   8010060b <cprintf>
      panic("trap");
80105122:	83 c4 14             	add    $0x14,%esp
80105125:	68 6e 6d 10 80       	push   $0x80106d6e
8010512a:	e8 19 b2 ff ff       	call   80100348 <panic>
    exit();
8010512f:	e8 77 e4 ff ff       	call   801035ab <exit>
80105134:	e9 94 fe ff ff       	jmp    80104fcd <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
80105139:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010513d:	0f 85 a2 fe ff ff    	jne    80104fe5 <trap+0xa3>
    yield();
80105143:	e8 2c e5 ff ff       	call   80103674 <yield>
80105148:	e9 98 fe ff ff       	jmp    80104fe5 <trap+0xa3>
    exit();
8010514d:	e8 59 e4 ff ff       	call   801035ab <exit>
80105152:	e9 b3 fe ff ff       	jmp    8010500a <trap+0xc8>
...
80105158:	89 e5                	mov    %esp,%ebp
  if(!uart)
8010515a:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
80105161:	74 15                	je     80105178 <uartgetc+0x21>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105163:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105168:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105169:	a8 01                	test   $0x1,%al
8010516b:	74 12                	je     8010517f <uartgetc+0x28>
8010516d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105172:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105173:	0f b6 c0             	movzbl %al,%eax
}
80105176:	5d                   	pop    %ebp
80105177:	c3                   	ret    
    return -1;
80105178:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010517d:	eb f7                	jmp    80105176 <uartgetc+0x1f>
    return -1;
8010517f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105184:	eb f0                	jmp    80105176 <uartgetc+0x1f>

80105186 <uartputc>:
  if(!uart)
80105186:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
8010518d:	74 3b                	je     801051ca <uartputc+0x44>
{
...
80105196:	bb 00 00 00 00       	mov    $0x0,%ebx
8010519b:	eb 10                	jmp    801051ad <uartputc+0x27>
    microdelay(10);
8010519d:	83 ec 0c             	sub    $0xc,%esp
801051a0:	6a 0a                	push   $0xa
801051a2:	e8 11 d2 ff ff       	call   801023b8 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801051a7:	83 c3 01             	add    $0x1,%ebx
801051aa:	83 c4 10             	add    $0x10,%esp
801051ad:	83 fb 7f             	cmp    $0x7f,%ebx
801051b0:	7f 0a                	jg     801051bc <uartputc+0x36>
801051b2:	ba fd 03 00 00       	mov    $0x3fd,%edx
801051b7:	ec                   	in     (%dx),%al
801051b8:	a8 20                	test   $0x20,%al
801051ba:	74 e1                	je     8010519d <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801051bc:	8b 45 08             	mov    0x8(%ebp),%eax
801051bf:	ba f8 03 00 00       	mov    $0x3f8,%edx
801051c4:	ee                   	out    %al,(%dx)
}
801051c5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801051c8:	c9                   	leave  
801051c9:	c3                   	ret    
801051ca:	f3 c3                	repz ret 
...
801051d1:	b9 00 00 00 00       	mov    $0x0,%ecx
801051d6:	ba fa 03 00 00       	mov    $0x3fa,%edx
801051db:	89 c8                	mov    %ecx,%eax
801051dd:	ee                   	out    %al,(%dx)
801051de:	be fb 03 00 00       	mov    $0x3fb,%esi
801051e3:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801051e8:	89 f2                	mov    %esi,%edx
801051ea:	ee                   	out    %al,(%dx)
801051eb:	b8 0c 00 00 00       	mov    $0xc,%eax
801051f0:	ba f8 03 00 00       	mov    $0x3f8,%edx
801051f5:	ee                   	out    %al,(%dx)
801051f6:	bb f9 03 00 00       	mov    $0x3f9,%ebx
801051fb:	89 c8                	mov    %ecx,%eax
801051fd:	89 da                	mov    %ebx,%edx
801051ff:	ee                   	out    %al,(%dx)
80105200:	b8 03 00 00 00       	mov    $0x3,%eax
80105205:	89 f2                	mov    %esi,%edx
80105207:	ee                   	out    %al,(%dx)
80105208:	ba fc 03 00 00       	mov    $0x3fc,%edx
8010520d:	89 c8                	mov    %ecx,%eax
8010520f:	ee                   	out    %al,(%dx)
80105210:	b8 01 00 00 00       	mov    $0x1,%eax
80105215:	89 da                	mov    %ebx,%edx
80105217:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105218:	ba fd 03 00 00       	mov    $0x3fd,%edx
8010521d:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
8010521e:	3c ff                	cmp    $0xff,%al
80105220:	74 45                	je     80105267 <uartinit+0x9b>
  uart = 1;
80105222:	c7 05 bc 95 10 80 01 	movl   $0x1,0x801095bc
80105229:	00 00 00 
8010522c:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105231:	ec                   	in     (%dx),%al
80105232:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105237:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105238:	83 ec 08             	sub    $0x8,%esp
8010523b:	6a 00                	push   $0x0
8010523d:	6a 04                	push   $0x4
8010523f:	e8 3a cd ff ff       	call   80101f7e <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105244:	83 c4 10             	add    $0x10,%esp
80105247:	bb 90 6e 10 80       	mov    $0x80106e90,%ebx
8010524c:	eb 12                	jmp    80105260 <uartinit+0x94>
    uartputc(*p);
8010524e:	83 ec 0c             	sub    $0xc,%esp
80105251:	0f be c0             	movsbl %al,%eax
80105254:	50                   	push   %eax
80105255:	e8 2c ff ff ff       	call   80105186 <uartputc>
  for(p="xv6...\n"; *p; p++)
8010525a:	83 c3 01             	add    $0x1,%ebx
8010525d:	83 c4 10             	add    $0x10,%esp
80105260:	0f b6 03             	movzbl (%ebx),%eax
80105263:	84 c0                	test   %al,%al
80105265:	75 e7                	jne    8010524e <uartinit+0x82>
}
...
80105271:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105274:	68 57 51 10 80       	push   $0x80105157
80105279:	e8 c0 b4 ff ff       	call   8010073e <consoleintr>
}
...
80105285:	6a 00                	push   $0x0
  jmp alltraps
80105287:	e9 be fb ff ff       	jmp    80104e4a <alltraps>
...
8010528c:	6a 00                	push   $0x0
  pushl $1
8010528e:	6a 01                	push   $0x1
  jmp alltraps
80105290:	e9 b5 fb ff ff       	jmp    80104e4a <alltraps>
...
80105297:	6a 02                	push   $0x2
  jmp alltraps
80105299:	e9 ac fb ff ff       	jmp    80104e4a <alltraps>
...
8010529e:	6a 00                	push   $0x0
  pushl $3
801052a0:	6a 03                	push   $0x3
  jmp alltraps
801052a2:	e9 a3 fb ff ff       	jmp    80104e4a <alltraps>
...
801052a9:	6a 04                	push   $0x4
  jmp alltraps
801052ab:	e9 9a fb ff ff       	jmp    80104e4a <alltraps>
...
801052b0:	6a 00                	push   $0x0
  pushl $5
801052b2:	6a 05                	push   $0x5
  jmp alltraps
801052b4:	e9 91 fb ff ff       	jmp    80104e4a <alltraps>
...
801052b9:	6a 00                	push   $0x0
  pushl $6
801052bb:	6a 06                	push   $0x6
  jmp alltraps
801052bd:	e9 88 fb ff ff       	jmp    80104e4a <alltraps>
...
801052c2:	6a 00                	push   $0x0
  pushl $7
801052c4:	6a 07                	push   $0x7
  jmp alltraps
801052c6:	e9 7f fb ff ff       	jmp    80104e4a <alltraps>

801052cb <vector8>:
.globl vector8
vector8:
  pushl $8
801052cb:	6a 08                	push   $0x8
  jmp alltraps
801052cd:	e9 78 fb ff ff       	jmp    80104e4a <alltraps>
...
801052d2:	6a 00                	push   $0x0
  pushl $9
801052d4:	6a 09                	push   $0x9
  jmp alltraps
801052d6:	e9 6f fb ff ff       	jmp    80104e4a <alltraps>

801052db <vector10>:
.globl vector10
vector10:
  pushl $10
801052db:	6a 0a                	push   $0xa
  jmp alltraps
801052dd:	e9 68 fb ff ff       	jmp    80104e4a <alltraps>

801052e2 <vector11>:
.globl vector11
vector11:
  pushl $11
801052e2:	6a 0b                	push   $0xb
  jmp alltraps
801052e4:	e9 61 fb ff ff       	jmp    80104e4a <alltraps>

801052e9 <vector12>:
.globl vector12
vector12:
  pushl $12
801052e9:	6a 0c                	push   $0xc
  jmp alltraps
801052eb:	e9 5a fb ff ff       	jmp    80104e4a <alltraps>

801052f0 <vector13>:
.globl vector13
vector13:
  pushl $13
801052f0:	6a 0d                	push   $0xd
  jmp alltraps
801052f2:	e9 53 fb ff ff       	jmp    80104e4a <alltraps>

801052f7 <vector14>:
.globl vector14
vector14:
  pushl $14
801052f7:	6a 0e                	push   $0xe
  jmp alltraps
801052f9:	e9 4c fb ff ff       	jmp    80104e4a <alltraps>
...
801052fe:	6a 00                	push   $0x0
  pushl $15
80105300:	6a 0f                	push   $0xf
  jmp alltraps
80105302:	e9 43 fb ff ff       	jmp    80104e4a <alltraps>
...
80105309:	6a 10                	push   $0x10
  jmp alltraps
8010530b:	e9 3a fb ff ff       	jmp    80104e4a <alltraps>

80105310 <vector17>:
.globl vector17
vector17:
  pushl $17
80105310:	6a 11                	push   $0x11
  jmp alltraps
80105312:	e9 33 fb ff ff       	jmp    80104e4a <alltraps>
...
80105317:	6a 00                	push   $0x0
  pushl $18
80105319:	6a 12                	push   $0x12
  jmp alltraps
8010531b:	e9 2a fb ff ff       	jmp    80104e4a <alltraps>
...
80105320:	6a 00                	push   $0x0
  pushl $19
80105322:	6a 13                	push   $0x13
  jmp alltraps
80105324:	e9 21 fb ff ff       	jmp    80104e4a <alltraps>
...
80105329:	6a 00                	push   $0x0
  pushl $20
8010532b:	6a 14                	push   $0x14
  jmp alltraps
8010532d:	e9 18 fb ff ff       	jmp    80104e4a <alltraps>
...
80105332:	6a 00                	push   $0x0
  pushl $21
80105334:	6a 15                	push   $0x15
  jmp alltraps
80105336:	e9 0f fb ff ff       	jmp    80104e4a <alltraps>
...
8010533b:	6a 00                	push   $0x0
  pushl $22
8010533d:	6a 16                	push   $0x16
  jmp alltraps
8010533f:	e9 06 fb ff ff       	jmp    80104e4a <alltraps>
...
80105344:	6a 00                	push   $0x0
  pushl $23
80105346:	6a 17                	push   $0x17
  jmp alltraps
80105348:	e9 fd fa ff ff       	jmp    80104e4a <alltraps>
...
8010534d:	6a 00                	push   $0x0
  pushl $24
8010534f:	6a 18                	push   $0x18
  jmp alltraps
80105351:	e9 f4 fa ff ff       	jmp    80104e4a <alltraps>
...
80105356:	6a 00                	push   $0x0
  pushl $25
80105358:	6a 19                	push   $0x19
  jmp alltraps
8010535a:	e9 eb fa ff ff       	jmp    80104e4a <alltraps>
...
8010535f:	6a 00                	push   $0x0
  pushl $26
80105361:	6a 1a                	push   $0x1a
  jmp alltraps
80105363:	e9 e2 fa ff ff       	jmp    80104e4a <alltraps>
...
80105368:	6a 00                	push   $0x0
  pushl $27
8010536a:	6a 1b                	push   $0x1b
  jmp alltraps
8010536c:	e9 d9 fa ff ff       	jmp    80104e4a <alltraps>
...
80105371:	6a 00                	push   $0x0
  pushl $28
80105373:	6a 1c                	push   $0x1c
  jmp alltraps
80105375:	e9 d0 fa ff ff       	jmp    80104e4a <alltraps>
...
8010537a:	6a 00                	push   $0x0
  pushl $29
8010537c:	6a 1d                	push   $0x1d
  jmp alltraps
8010537e:	e9 c7 fa ff ff       	jmp    80104e4a <alltraps>
...
80105383:	6a 00                	push   $0x0
  pushl $30
80105385:	6a 1e                	push   $0x1e
  jmp alltraps
80105387:	e9 be fa ff ff       	jmp    80104e4a <alltraps>
...
8010538c:	6a 00                	push   $0x0
  pushl $31
8010538e:	6a 1f                	push   $0x1f
  jmp alltraps
80105390:	e9 b5 fa ff ff       	jmp    80104e4a <alltraps>
...
80105395:	6a 00                	push   $0x0
  pushl $32
80105397:	6a 20                	push   $0x20
  jmp alltraps
80105399:	e9 ac fa ff ff       	jmp    80104e4a <alltraps>
...
8010539e:	6a 00                	push   $0x0
  pushl $33
801053a0:	6a 21                	push   $0x21
  jmp alltraps
801053a2:	e9 a3 fa ff ff       	jmp    80104e4a <alltraps>
...
801053a7:	6a 00                	push   $0x0
  pushl $34
801053a9:	6a 22                	push   $0x22
  jmp alltraps
801053ab:	e9 9a fa ff ff       	jmp    80104e4a <alltraps>
...
801053b0:	6a 00                	push   $0x0
  pushl $35
801053b2:	6a 23                	push   $0x23
  jmp alltraps
801053b4:	e9 91 fa ff ff       	jmp    80104e4a <alltraps>
...
801053b9:	6a 00                	push   $0x0
  pushl $36
801053bb:	6a 24                	push   $0x24
  jmp alltraps
801053bd:	e9 88 fa ff ff       	jmp    80104e4a <alltraps>
...
801053c2:	6a 00                	push   $0x0
  pushl $37
801053c4:	6a 25                	push   $0x25
  jmp alltraps
801053c6:	e9 7f fa ff ff       	jmp    80104e4a <alltraps>
...
801053cb:	6a 00                	push   $0x0
  pushl $38
801053cd:	6a 26                	push   $0x26
  jmp alltraps
801053cf:	e9 76 fa ff ff       	jmp    80104e4a <alltraps>
...
801053d4:	6a 00                	push   $0x0
  pushl $39
801053d6:	6a 27                	push   $0x27
  jmp alltraps
801053d8:	e9 6d fa ff ff       	jmp    80104e4a <alltraps>
...
801053dd:	6a 00                	push   $0x0
  pushl $40
801053df:	6a 28                	push   $0x28
  jmp alltraps
801053e1:	e9 64 fa ff ff       	jmp    80104e4a <alltraps>
...
801053e6:	6a 00                	push   $0x0
  pushl $41
801053e8:	6a 29                	push   $0x29
  jmp alltraps
801053ea:	e9 5b fa ff ff       	jmp    80104e4a <alltraps>
...
801053ef:	6a 00                	push   $0x0
  pushl $42
801053f1:	6a 2a                	push   $0x2a
  jmp alltraps
801053f3:	e9 52 fa ff ff       	jmp    80104e4a <alltraps>
...
801053f8:	6a 00                	push   $0x0
  pushl $43
801053fa:	6a 2b                	push   $0x2b
  jmp alltraps
801053fc:	e9 49 fa ff ff       	jmp    80104e4a <alltraps>
...
80105401:	6a 00                	push   $0x0
  pushl $44
80105403:	6a 2c                	push   $0x2c
  jmp alltraps
80105405:	e9 40 fa ff ff       	jmp    80104e4a <alltraps>
...
8010540a:	6a 00                	push   $0x0
  pushl $45
8010540c:	6a 2d                	push   $0x2d
  jmp alltraps
8010540e:	e9 37 fa ff ff       	jmp    80104e4a <alltraps>
...
80105413:	6a 00                	push   $0x0
  pushl $46
80105415:	6a 2e                	push   $0x2e
  jmp alltraps
80105417:	e9 2e fa ff ff       	jmp    80104e4a <alltraps>
...
8010541c:	6a 00                	push   $0x0
  pushl $47
8010541e:	6a 2f                	push   $0x2f
  jmp alltraps
80105420:	e9 25 fa ff ff       	jmp    80104e4a <alltraps>
...
80105425:	6a 00                	push   $0x0
  pushl $48
80105427:	6a 30                	push   $0x30
  jmp alltraps
80105429:	e9 1c fa ff ff       	jmp    80104e4a <alltraps>
...
8010542e:	6a 00                	push   $0x0
  pushl $49
80105430:	6a 31                	push   $0x31
  jmp alltraps
80105432:	e9 13 fa ff ff       	jmp    80104e4a <alltraps>
...
80105437:	6a 00                	push   $0x0
  pushl $50
80105439:	6a 32                	push   $0x32
  jmp alltraps
8010543b:	e9 0a fa ff ff       	jmp    80104e4a <alltraps>
...
80105440:	6a 00                	push   $0x0
  pushl $51
80105442:	6a 33                	push   $0x33
  jmp alltraps
80105444:	e9 01 fa ff ff       	jmp    80104e4a <alltraps>
...
80105449:	6a 00                	push   $0x0
  pushl $52
8010544b:	6a 34                	push   $0x34
  jmp alltraps
8010544d:	e9 f8 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105452:	6a 00                	push   $0x0
  pushl $53
80105454:	6a 35                	push   $0x35
  jmp alltraps
80105456:	e9 ef f9 ff ff       	jmp    80104e4a <alltraps>
...
8010545b:	6a 00                	push   $0x0
  pushl $54
8010545d:	6a 36                	push   $0x36
  jmp alltraps
8010545f:	e9 e6 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105464:	6a 00                	push   $0x0
  pushl $55
80105466:	6a 37                	push   $0x37
  jmp alltraps
80105468:	e9 dd f9 ff ff       	jmp    80104e4a <alltraps>
...
8010546d:	6a 00                	push   $0x0
  pushl $56
8010546f:	6a 38                	push   $0x38
  jmp alltraps
80105471:	e9 d4 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105476:	6a 00                	push   $0x0
  pushl $57
80105478:	6a 39                	push   $0x39
  jmp alltraps
8010547a:	e9 cb f9 ff ff       	jmp    80104e4a <alltraps>
...
8010547f:	6a 00                	push   $0x0
  pushl $58
80105481:	6a 3a                	push   $0x3a
  jmp alltraps
80105483:	e9 c2 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105488:	6a 00                	push   $0x0
  pushl $59
8010548a:	6a 3b                	push   $0x3b
  jmp alltraps
8010548c:	e9 b9 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105491:	6a 00                	push   $0x0
  pushl $60
80105493:	6a 3c                	push   $0x3c
  jmp alltraps
80105495:	e9 b0 f9 ff ff       	jmp    80104e4a <alltraps>
...
8010549a:	6a 00                	push   $0x0
  pushl $61
8010549c:	6a 3d                	push   $0x3d
  jmp alltraps
8010549e:	e9 a7 f9 ff ff       	jmp    80104e4a <alltraps>
...
801054a3:	6a 00                	push   $0x0
  pushl $62
801054a5:	6a 3e                	push   $0x3e
  jmp alltraps
801054a7:	e9 9e f9 ff ff       	jmp    80104e4a <alltraps>
...
801054ac:	6a 00                	push   $0x0
  pushl $63
801054ae:	6a 3f                	push   $0x3f
  jmp alltraps
801054b0:	e9 95 f9 ff ff       	jmp    80104e4a <alltraps>
...
801054b5:	6a 00                	push   $0x0
  pushl $64
801054b7:	6a 40                	push   $0x40
  jmp alltraps
801054b9:	e9 8c f9 ff ff       	jmp    80104e4a <alltraps>
...
801054be:	6a 00                	push   $0x0
  pushl $65
801054c0:	6a 41                	push   $0x41
  jmp alltraps
801054c2:	e9 83 f9 ff ff       	jmp    80104e4a <alltraps>
...
801054c7:	6a 00                	push   $0x0
  pushl $66
801054c9:	6a 42                	push   $0x42
  jmp alltraps
801054cb:	e9 7a f9 ff ff       	jmp    80104e4a <alltraps>
...
801054d0:	6a 00                	push   $0x0
  pushl $67
801054d2:	6a 43                	push   $0x43
  jmp alltraps
801054d4:	e9 71 f9 ff ff       	jmp    80104e4a <alltraps>
...
801054d9:	6a 00                	push   $0x0
  pushl $68
801054db:	6a 44                	push   $0x44
  jmp alltraps
801054dd:	e9 68 f9 ff ff       	jmp    80104e4a <alltraps>
...
801054e2:	6a 00                	push   $0x0
  pushl $69
801054e4:	6a 45                	push   $0x45
  jmp alltraps
801054e6:	e9 5f f9 ff ff       	jmp    80104e4a <alltraps>
...
801054eb:	6a 00                	push   $0x0
  pushl $70
801054ed:	6a 46                	push   $0x46
  jmp alltraps
801054ef:	e9 56 f9 ff ff       	jmp    80104e4a <alltraps>
...
801054f4:	6a 00                	push   $0x0
  pushl $71
801054f6:	6a 47                	push   $0x47
  jmp alltraps
801054f8:	e9 4d f9 ff ff       	jmp    80104e4a <alltraps>
...
801054fd:	6a 00                	push   $0x0
  pushl $72
801054ff:	6a 48                	push   $0x48
  jmp alltraps
80105501:	e9 44 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105506:	6a 00                	push   $0x0
  pushl $73
80105508:	6a 49                	push   $0x49
  jmp alltraps
8010550a:	e9 3b f9 ff ff       	jmp    80104e4a <alltraps>
...
8010550f:	6a 00                	push   $0x0
  pushl $74
80105511:	6a 4a                	push   $0x4a
  jmp alltraps
80105513:	e9 32 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105518:	6a 00                	push   $0x0
  pushl $75
8010551a:	6a 4b                	push   $0x4b
  jmp alltraps
8010551c:	e9 29 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105521:	6a 00                	push   $0x0
  pushl $76
80105523:	6a 4c                	push   $0x4c
  jmp alltraps
80105525:	e9 20 f9 ff ff       	jmp    80104e4a <alltraps>
...
8010552a:	6a 00                	push   $0x0
  pushl $77
8010552c:	6a 4d                	push   $0x4d
  jmp alltraps
8010552e:	e9 17 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105533:	6a 00                	push   $0x0
  pushl $78
80105535:	6a 4e                	push   $0x4e
  jmp alltraps
80105537:	e9 0e f9 ff ff       	jmp    80104e4a <alltraps>
...
8010553c:	6a 00                	push   $0x0
  pushl $79
8010553e:	6a 4f                	push   $0x4f
  jmp alltraps
80105540:	e9 05 f9 ff ff       	jmp    80104e4a <alltraps>
...
80105545:	6a 00                	push   $0x0
  pushl $80
80105547:	6a 50                	push   $0x50
  jmp alltraps
80105549:	e9 fc f8 ff ff       	jmp    80104e4a <alltraps>
...
8010554e:	6a 00                	push   $0x0
  pushl $81
80105550:	6a 51                	push   $0x51
  jmp alltraps
80105552:	e9 f3 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105557:	6a 00                	push   $0x0
  pushl $82
80105559:	6a 52                	push   $0x52
  jmp alltraps
8010555b:	e9 ea f8 ff ff       	jmp    80104e4a <alltraps>
...
80105560:	6a 00                	push   $0x0
  pushl $83
80105562:	6a 53                	push   $0x53
  jmp alltraps
80105564:	e9 e1 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105569:	6a 00                	push   $0x0
  pushl $84
8010556b:	6a 54                	push   $0x54
  jmp alltraps
8010556d:	e9 d8 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105572:	6a 00                	push   $0x0
  pushl $85
80105574:	6a 55                	push   $0x55
  jmp alltraps
80105576:	e9 cf f8 ff ff       	jmp    80104e4a <alltraps>
...
8010557b:	6a 00                	push   $0x0
  pushl $86
8010557d:	6a 56                	push   $0x56
  jmp alltraps
8010557f:	e9 c6 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105584:	6a 00                	push   $0x0
  pushl $87
80105586:	6a 57                	push   $0x57
  jmp alltraps
80105588:	e9 bd f8 ff ff       	jmp    80104e4a <alltraps>
...
8010558d:	6a 00                	push   $0x0
  pushl $88
8010558f:	6a 58                	push   $0x58
  jmp alltraps
80105591:	e9 b4 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105596:	6a 00                	push   $0x0
  pushl $89
80105598:	6a 59                	push   $0x59
  jmp alltraps
8010559a:	e9 ab f8 ff ff       	jmp    80104e4a <alltraps>
...
8010559f:	6a 00                	push   $0x0
  pushl $90
801055a1:	6a 5a                	push   $0x5a
  jmp alltraps
801055a3:	e9 a2 f8 ff ff       	jmp    80104e4a <alltraps>
...
801055a8:	6a 00                	push   $0x0
  pushl $91
801055aa:	6a 5b                	push   $0x5b
  jmp alltraps
801055ac:	e9 99 f8 ff ff       	jmp    80104e4a <alltraps>
...
801055b1:	6a 00                	push   $0x0
  pushl $92
801055b3:	6a 5c                	push   $0x5c
  jmp alltraps
801055b5:	e9 90 f8 ff ff       	jmp    80104e4a <alltraps>
...
801055ba:	6a 00                	push   $0x0
  pushl $93
801055bc:	6a 5d                	push   $0x5d
  jmp alltraps
801055be:	e9 87 f8 ff ff       	jmp    80104e4a <alltraps>
...
801055c3:	6a 00                	push   $0x0
  pushl $94
801055c5:	6a 5e                	push   $0x5e
  jmp alltraps
801055c7:	e9 7e f8 ff ff       	jmp    80104e4a <alltraps>
...
801055cc:	6a 00                	push   $0x0
  pushl $95
801055ce:	6a 5f                	push   $0x5f
  jmp alltraps
801055d0:	e9 75 f8 ff ff       	jmp    80104e4a <alltraps>
...
801055d5:	6a 00                	push   $0x0
  pushl $96
801055d7:	6a 60                	push   $0x60
  jmp alltraps
801055d9:	e9 6c f8 ff ff       	jmp    80104e4a <alltraps>
...
801055de:	6a 00                	push   $0x0
  pushl $97
801055e0:	6a 61                	push   $0x61
  jmp alltraps
801055e2:	e9 63 f8 ff ff       	jmp    80104e4a <alltraps>
...
801055e7:	6a 00                	push   $0x0
  pushl $98
801055e9:	6a 62                	push   $0x62
  jmp alltraps
801055eb:	e9 5a f8 ff ff       	jmp    80104e4a <alltraps>
...
801055f0:	6a 00                	push   $0x0
  pushl $99
801055f2:	6a 63                	push   $0x63
  jmp alltraps
801055f4:	e9 51 f8 ff ff       	jmp    80104e4a <alltraps>
...
801055f9:	6a 00                	push   $0x0
  pushl $100
801055fb:	6a 64                	push   $0x64
  jmp alltraps
801055fd:	e9 48 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105602:	6a 00                	push   $0x0
  pushl $101
80105604:	6a 65                	push   $0x65
  jmp alltraps
80105606:	e9 3f f8 ff ff       	jmp    80104e4a <alltraps>
...
8010560b:	6a 00                	push   $0x0
  pushl $102
8010560d:	6a 66                	push   $0x66
  jmp alltraps
8010560f:	e9 36 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105614:	6a 00                	push   $0x0
  pushl $103
80105616:	6a 67                	push   $0x67
  jmp alltraps
80105618:	e9 2d f8 ff ff       	jmp    80104e4a <alltraps>
...
8010561d:	6a 00                	push   $0x0
  pushl $104
8010561f:	6a 68                	push   $0x68
  jmp alltraps
80105621:	e9 24 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105626:	6a 00                	push   $0x0
  pushl $105
80105628:	6a 69                	push   $0x69
  jmp alltraps
8010562a:	e9 1b f8 ff ff       	jmp    80104e4a <alltraps>
...
8010562f:	6a 00                	push   $0x0
  pushl $106
80105631:	6a 6a                	push   $0x6a
  jmp alltraps
80105633:	e9 12 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105638:	6a 00                	push   $0x0
  pushl $107
8010563a:	6a 6b                	push   $0x6b
  jmp alltraps
8010563c:	e9 09 f8 ff ff       	jmp    80104e4a <alltraps>
...
80105641:	6a 00                	push   $0x0
  pushl $108
80105643:	6a 6c                	push   $0x6c
  jmp alltraps
80105645:	e9 00 f8 ff ff       	jmp    80104e4a <alltraps>
...
8010564a:	6a 00                	push   $0x0
  pushl $109
8010564c:	6a 6d                	push   $0x6d
  jmp alltraps
8010564e:	e9 f7 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105653:	6a 00                	push   $0x0
  pushl $110
80105655:	6a 6e                	push   $0x6e
  jmp alltraps
80105657:	e9 ee f7 ff ff       	jmp    80104e4a <alltraps>
...
8010565c:	6a 00                	push   $0x0
  pushl $111
8010565e:	6a 6f                	push   $0x6f
  jmp alltraps
80105660:	e9 e5 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105665:	6a 00                	push   $0x0
  pushl $112
80105667:	6a 70                	push   $0x70
  jmp alltraps
80105669:	e9 dc f7 ff ff       	jmp    80104e4a <alltraps>
...
8010566e:	6a 00                	push   $0x0
  pushl $113
80105670:	6a 71                	push   $0x71
  jmp alltraps
80105672:	e9 d3 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105677:	6a 00                	push   $0x0
  pushl $114
80105679:	6a 72                	push   $0x72
  jmp alltraps
8010567b:	e9 ca f7 ff ff       	jmp    80104e4a <alltraps>
...
80105680:	6a 00                	push   $0x0
  pushl $115
80105682:	6a 73                	push   $0x73
  jmp alltraps
80105684:	e9 c1 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105689:	6a 00                	push   $0x0
  pushl $116
8010568b:	6a 74                	push   $0x74
  jmp alltraps
8010568d:	e9 b8 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105692:	6a 00                	push   $0x0
  pushl $117
80105694:	6a 75                	push   $0x75
  jmp alltraps
80105696:	e9 af f7 ff ff       	jmp    80104e4a <alltraps>
...
8010569b:	6a 00                	push   $0x0
  pushl $118
8010569d:	6a 76                	push   $0x76
  jmp alltraps
8010569f:	e9 a6 f7 ff ff       	jmp    80104e4a <alltraps>
...
801056a4:	6a 00                	push   $0x0
  pushl $119
801056a6:	6a 77                	push   $0x77
  jmp alltraps
801056a8:	e9 9d f7 ff ff       	jmp    80104e4a <alltraps>
...
801056ad:	6a 00                	push   $0x0
  pushl $120
801056af:	6a 78                	push   $0x78
  jmp alltraps
801056b1:	e9 94 f7 ff ff       	jmp    80104e4a <alltraps>
...
801056b6:	6a 00                	push   $0x0
  pushl $121
801056b8:	6a 79                	push   $0x79
  jmp alltraps
801056ba:	e9 8b f7 ff ff       	jmp    80104e4a <alltraps>
...
801056bf:	6a 00                	push   $0x0
  pushl $122
801056c1:	6a 7a                	push   $0x7a
  jmp alltraps
801056c3:	e9 82 f7 ff ff       	jmp    80104e4a <alltraps>
...
801056c8:	6a 00                	push   $0x0
  pushl $123
801056ca:	6a 7b                	push   $0x7b
  jmp alltraps
801056cc:	e9 79 f7 ff ff       	jmp    80104e4a <alltraps>
...
801056d1:	6a 00                	push   $0x0
  pushl $124
801056d3:	6a 7c                	push   $0x7c
  jmp alltraps
801056d5:	e9 70 f7 ff ff       	jmp    80104e4a <alltraps>
...
801056da:	6a 00                	push   $0x0
  pushl $125
801056dc:	6a 7d                	push   $0x7d
  jmp alltraps
801056de:	e9 67 f7 ff ff       	jmp    80104e4a <alltraps>
...
801056e3:	6a 00                	push   $0x0
  pushl $126
801056e5:	6a 7e                	push   $0x7e
  jmp alltraps
801056e7:	e9 5e f7 ff ff       	jmp    80104e4a <alltraps>
...
801056ec:	6a 00                	push   $0x0
  pushl $127
801056ee:	6a 7f                	push   $0x7f
  jmp alltraps
801056f0:	e9 55 f7 ff ff       	jmp    80104e4a <alltraps>
...
801056f5:	6a 00                	push   $0x0
  pushl $128
801056f7:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801056fc:	e9 49 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105701:	6a 00                	push   $0x0
  pushl $129
80105703:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105708:	e9 3d f7 ff ff       	jmp    80104e4a <alltraps>
...
8010570d:	6a 00                	push   $0x0
  pushl $130
8010570f:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105714:	e9 31 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105719:	6a 00                	push   $0x0
  pushl $131
8010571b:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105720:	e9 25 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105725:	6a 00                	push   $0x0
  pushl $132
80105727:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010572c:	e9 19 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105731:	6a 00                	push   $0x0
  pushl $133
80105733:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105738:	e9 0d f7 ff ff       	jmp    80104e4a <alltraps>
...
8010573d:	6a 00                	push   $0x0
  pushl $134
8010573f:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105744:	e9 01 f7 ff ff       	jmp    80104e4a <alltraps>
...
80105749:	6a 00                	push   $0x0
  pushl $135
8010574b:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105750:	e9 f5 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105755:	6a 00                	push   $0x0
  pushl $136
80105757:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010575c:	e9 e9 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105761:	6a 00                	push   $0x0
  pushl $137
80105763:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105768:	e9 dd f6 ff ff       	jmp    80104e4a <alltraps>
...
8010576d:	6a 00                	push   $0x0
  pushl $138
8010576f:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105774:	e9 d1 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105779:	6a 00                	push   $0x0
  pushl $139
8010577b:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105780:	e9 c5 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105785:	6a 00                	push   $0x0
  pushl $140
80105787:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010578c:	e9 b9 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105791:	6a 00                	push   $0x0
  pushl $141
80105793:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105798:	e9 ad f6 ff ff       	jmp    80104e4a <alltraps>
...
8010579d:	6a 00                	push   $0x0
  pushl $142
8010579f:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801057a4:	e9 a1 f6 ff ff       	jmp    80104e4a <alltraps>
...
801057a9:	6a 00                	push   $0x0
  pushl $143
801057ab:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801057b0:	e9 95 f6 ff ff       	jmp    80104e4a <alltraps>
...
801057b5:	6a 00                	push   $0x0
  pushl $144
801057b7:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801057bc:	e9 89 f6 ff ff       	jmp    80104e4a <alltraps>
...
801057c1:	6a 00                	push   $0x0
  pushl $145
801057c3:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801057c8:	e9 7d f6 ff ff       	jmp    80104e4a <alltraps>
...
801057cd:	6a 00                	push   $0x0
  pushl $146
801057cf:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801057d4:	e9 71 f6 ff ff       	jmp    80104e4a <alltraps>
...
801057d9:	6a 00                	push   $0x0
  pushl $147
801057db:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801057e0:	e9 65 f6 ff ff       	jmp    80104e4a <alltraps>
...
801057e5:	6a 00                	push   $0x0
  pushl $148
801057e7:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801057ec:	e9 59 f6 ff ff       	jmp    80104e4a <alltraps>
...
801057f1:	6a 00                	push   $0x0
  pushl $149
801057f3:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801057f8:	e9 4d f6 ff ff       	jmp    80104e4a <alltraps>
...
801057fd:	6a 00                	push   $0x0
  pushl $150
801057ff:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105804:	e9 41 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105809:	6a 00                	push   $0x0
  pushl $151
8010580b:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105810:	e9 35 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105815:	6a 00                	push   $0x0
  pushl $152
80105817:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010581c:	e9 29 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105821:	6a 00                	push   $0x0
  pushl $153
80105823:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105828:	e9 1d f6 ff ff       	jmp    80104e4a <alltraps>
...
8010582d:	6a 00                	push   $0x0
  pushl $154
8010582f:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105834:	e9 11 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105839:	6a 00                	push   $0x0
  pushl $155
8010583b:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105840:	e9 05 f6 ff ff       	jmp    80104e4a <alltraps>
...
80105845:	6a 00                	push   $0x0
  pushl $156
80105847:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010584c:	e9 f9 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105851:	6a 00                	push   $0x0
  pushl $157
80105853:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105858:	e9 ed f5 ff ff       	jmp    80104e4a <alltraps>
...
8010585d:	6a 00                	push   $0x0
  pushl $158
8010585f:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105864:	e9 e1 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105869:	6a 00                	push   $0x0
  pushl $159
8010586b:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105870:	e9 d5 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105875:	6a 00                	push   $0x0
  pushl $160
80105877:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010587c:	e9 c9 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105881:	6a 00                	push   $0x0
  pushl $161
80105883:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105888:	e9 bd f5 ff ff       	jmp    80104e4a <alltraps>
...
8010588d:	6a 00                	push   $0x0
  pushl $162
8010588f:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105894:	e9 b1 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105899:	6a 00                	push   $0x0
  pushl $163
8010589b:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801058a0:	e9 a5 f5 ff ff       	jmp    80104e4a <alltraps>
...
801058a5:	6a 00                	push   $0x0
  pushl $164
801058a7:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801058ac:	e9 99 f5 ff ff       	jmp    80104e4a <alltraps>
...
801058b1:	6a 00                	push   $0x0
  pushl $165
801058b3:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801058b8:	e9 8d f5 ff ff       	jmp    80104e4a <alltraps>
...
801058bd:	6a 00                	push   $0x0
  pushl $166
801058bf:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801058c4:	e9 81 f5 ff ff       	jmp    80104e4a <alltraps>
...
801058c9:	6a 00                	push   $0x0
  pushl $167
801058cb:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801058d0:	e9 75 f5 ff ff       	jmp    80104e4a <alltraps>
...
801058d5:	6a 00                	push   $0x0
  pushl $168
801058d7:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801058dc:	e9 69 f5 ff ff       	jmp    80104e4a <alltraps>
...
801058e1:	6a 00                	push   $0x0
  pushl $169
801058e3:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801058e8:	e9 5d f5 ff ff       	jmp    80104e4a <alltraps>
...
801058ed:	6a 00                	push   $0x0
  pushl $170
801058ef:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801058f4:	e9 51 f5 ff ff       	jmp    80104e4a <alltraps>
...
801058f9:	6a 00                	push   $0x0
  pushl $171
801058fb:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105900:	e9 45 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105905:	6a 00                	push   $0x0
  pushl $172
80105907:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010590c:	e9 39 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105911:	6a 00                	push   $0x0
  pushl $173
80105913:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105918:	e9 2d f5 ff ff       	jmp    80104e4a <alltraps>
...
8010591d:	6a 00                	push   $0x0
  pushl $174
8010591f:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105924:	e9 21 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105929:	6a 00                	push   $0x0
  pushl $175
8010592b:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105930:	e9 15 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105935:	6a 00                	push   $0x0
  pushl $176
80105937:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010593c:	e9 09 f5 ff ff       	jmp    80104e4a <alltraps>
...
80105941:	6a 00                	push   $0x0
  pushl $177
80105943:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105948:	e9 fd f4 ff ff       	jmp    80104e4a <alltraps>
...
8010594d:	6a 00                	push   $0x0
  pushl $178
8010594f:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105954:	e9 f1 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105959:	6a 00                	push   $0x0
  pushl $179
8010595b:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105960:	e9 e5 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105965:	6a 00                	push   $0x0
  pushl $180
80105967:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010596c:	e9 d9 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105971:	6a 00                	push   $0x0
  pushl $181
80105973:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105978:	e9 cd f4 ff ff       	jmp    80104e4a <alltraps>
...
8010597d:	6a 00                	push   $0x0
  pushl $182
8010597f:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105984:	e9 c1 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105989:	6a 00                	push   $0x0
  pushl $183
8010598b:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105990:	e9 b5 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105995:	6a 00                	push   $0x0
  pushl $184
80105997:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010599c:	e9 a9 f4 ff ff       	jmp    80104e4a <alltraps>
...
801059a1:	6a 00                	push   $0x0
  pushl $185
801059a3:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801059a8:	e9 9d f4 ff ff       	jmp    80104e4a <alltraps>
...
801059ad:	6a 00                	push   $0x0
  pushl $186
801059af:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801059b4:	e9 91 f4 ff ff       	jmp    80104e4a <alltraps>
...
801059b9:	6a 00                	push   $0x0
  pushl $187
801059bb:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801059c0:	e9 85 f4 ff ff       	jmp    80104e4a <alltraps>
...
801059c5:	6a 00                	push   $0x0
  pushl $188
801059c7:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801059cc:	e9 79 f4 ff ff       	jmp    80104e4a <alltraps>
...
801059d1:	6a 00                	push   $0x0
  pushl $189
801059d3:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801059d8:	e9 6d f4 ff ff       	jmp    80104e4a <alltraps>
...
801059dd:	6a 00                	push   $0x0
  pushl $190
801059df:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801059e4:	e9 61 f4 ff ff       	jmp    80104e4a <alltraps>
...
801059e9:	6a 00                	push   $0x0
  pushl $191
801059eb:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801059f0:	e9 55 f4 ff ff       	jmp    80104e4a <alltraps>
...
801059f5:	6a 00                	push   $0x0
  pushl $192
801059f7:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801059fc:	e9 49 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105a01:	6a 00                	push   $0x0
  pushl $193
80105a03:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105a08:	e9 3d f4 ff ff       	jmp    80104e4a <alltraps>
...
80105a0d:	6a 00                	push   $0x0
  pushl $194
80105a0f:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105a14:	e9 31 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105a19:	6a 00                	push   $0x0
  pushl $195
80105a1b:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105a20:	e9 25 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105a25:	6a 00                	push   $0x0
  pushl $196
80105a27:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105a2c:	e9 19 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105a31:	6a 00                	push   $0x0
  pushl $197
80105a33:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105a38:	e9 0d f4 ff ff       	jmp    80104e4a <alltraps>
...
80105a3d:	6a 00                	push   $0x0
  pushl $198
80105a3f:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80105a44:	e9 01 f4 ff ff       	jmp    80104e4a <alltraps>
...
80105a49:	6a 00                	push   $0x0
  pushl $199
80105a4b:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105a50:	e9 f5 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105a55:	6a 00                	push   $0x0
  pushl $200
80105a57:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80105a5c:	e9 e9 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105a61:	6a 00                	push   $0x0
  pushl $201
80105a63:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105a68:	e9 dd f3 ff ff       	jmp    80104e4a <alltraps>
...
80105a6d:	6a 00                	push   $0x0
  pushl $202
80105a6f:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105a74:	e9 d1 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105a79:	6a 00                	push   $0x0
  pushl $203
80105a7b:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105a80:	e9 c5 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105a85:	6a 00                	push   $0x0
  pushl $204
80105a87:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105a8c:	e9 b9 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105a91:	6a 00                	push   $0x0
  pushl $205
80105a93:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105a98:	e9 ad f3 ff ff       	jmp    80104e4a <alltraps>
...
80105a9d:	6a 00                	push   $0x0
  pushl $206
80105a9f:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105aa4:	e9 a1 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105aa9:	6a 00                	push   $0x0
  pushl $207
80105aab:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105ab0:	e9 95 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105ab5:	6a 00                	push   $0x0
  pushl $208
80105ab7:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105abc:	e9 89 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105ac1:	6a 00                	push   $0x0
  pushl $209
80105ac3:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105ac8:	e9 7d f3 ff ff       	jmp    80104e4a <alltraps>
...
80105acd:	6a 00                	push   $0x0
  pushl $210
80105acf:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105ad4:	e9 71 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105ad9:	6a 00                	push   $0x0
  pushl $211
80105adb:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105ae0:	e9 65 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105ae5:	6a 00                	push   $0x0
  pushl $212
80105ae7:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105aec:	e9 59 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105af1:	6a 00                	push   $0x0
  pushl $213
80105af3:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105af8:	e9 4d f3 ff ff       	jmp    80104e4a <alltraps>
...
80105afd:	6a 00                	push   $0x0
  pushl $214
80105aff:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105b04:	e9 41 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105b09:	6a 00                	push   $0x0
  pushl $215
80105b0b:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105b10:	e9 35 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105b15:	6a 00                	push   $0x0
  pushl $216
80105b17:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105b1c:	e9 29 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105b21:	6a 00                	push   $0x0
  pushl $217
80105b23:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105b28:	e9 1d f3 ff ff       	jmp    80104e4a <alltraps>
...
80105b2d:	6a 00                	push   $0x0
  pushl $218
80105b2f:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105b34:	e9 11 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105b39:	6a 00                	push   $0x0
  pushl $219
80105b3b:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105b40:	e9 05 f3 ff ff       	jmp    80104e4a <alltraps>
...
80105b45:	6a 00                	push   $0x0
  pushl $220
80105b47:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105b4c:	e9 f9 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105b51:	6a 00                	push   $0x0
  pushl $221
80105b53:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105b58:	e9 ed f2 ff ff       	jmp    80104e4a <alltraps>
...
80105b5d:	6a 00                	push   $0x0
  pushl $222
80105b5f:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105b64:	e9 e1 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105b69:	6a 00                	push   $0x0
  pushl $223
80105b6b:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105b70:	e9 d5 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105b75:	6a 00                	push   $0x0
  pushl $224
80105b77:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105b7c:	e9 c9 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105b81:	6a 00                	push   $0x0
  pushl $225
80105b83:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105b88:	e9 bd f2 ff ff       	jmp    80104e4a <alltraps>
...
80105b8d:	6a 00                	push   $0x0
  pushl $226
80105b8f:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105b94:	e9 b1 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105b99:	6a 00                	push   $0x0
  pushl $227
80105b9b:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105ba0:	e9 a5 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105ba5:	6a 00                	push   $0x0
  pushl $228
80105ba7:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105bac:	e9 99 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105bb1:	6a 00                	push   $0x0
  pushl $229
80105bb3:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105bb8:	e9 8d f2 ff ff       	jmp    80104e4a <alltraps>
...
80105bbd:	6a 00                	push   $0x0
  pushl $230
80105bbf:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105bc4:	e9 81 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105bc9:	6a 00                	push   $0x0
  pushl $231
80105bcb:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105bd0:	e9 75 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105bd5:	6a 00                	push   $0x0
  pushl $232
80105bd7:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105bdc:	e9 69 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105be1:	6a 00                	push   $0x0
  pushl $233
80105be3:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105be8:	e9 5d f2 ff ff       	jmp    80104e4a <alltraps>
...
80105bed:	6a 00                	push   $0x0
  pushl $234
80105bef:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105bf4:	e9 51 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105bf9:	6a 00                	push   $0x0
  pushl $235
80105bfb:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105c00:	e9 45 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105c05:	6a 00                	push   $0x0
  pushl $236
80105c07:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105c0c:	e9 39 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105c11:	6a 00                	push   $0x0
  pushl $237
80105c13:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105c18:	e9 2d f2 ff ff       	jmp    80104e4a <alltraps>
...
80105c1d:	6a 00                	push   $0x0
  pushl $238
80105c1f:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105c24:	e9 21 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105c29:	6a 00                	push   $0x0
  pushl $239
80105c2b:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105c30:	e9 15 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105c35:	6a 00                	push   $0x0
  pushl $240
80105c37:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105c3c:	e9 09 f2 ff ff       	jmp    80104e4a <alltraps>
...
80105c41:	6a 00                	push   $0x0
  pushl $241
80105c43:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105c48:	e9 fd f1 ff ff       	jmp    80104e4a <alltraps>
...
80105c4d:	6a 00                	push   $0x0
  pushl $242
80105c4f:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105c54:	e9 f1 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105c59:	6a 00                	push   $0x0
  pushl $243
80105c5b:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105c60:	e9 e5 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105c65:	6a 00                	push   $0x0
  pushl $244
80105c67:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105c6c:	e9 d9 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105c71:	6a 00                	push   $0x0
  pushl $245
80105c73:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105c78:	e9 cd f1 ff ff       	jmp    80104e4a <alltraps>
...
80105c7d:	6a 00                	push   $0x0
  pushl $246
80105c7f:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105c84:	e9 c1 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105c89:	6a 00                	push   $0x0
  pushl $247
80105c8b:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105c90:	e9 b5 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105c95:	6a 00                	push   $0x0
  pushl $248
80105c97:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105c9c:	e9 a9 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105ca1:	6a 00                	push   $0x0
  pushl $249
80105ca3:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105ca8:	e9 9d f1 ff ff       	jmp    80104e4a <alltraps>
...
80105cad:	6a 00                	push   $0x0
  pushl $250
80105caf:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105cb4:	e9 91 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105cb9:	6a 00                	push   $0x0
  pushl $251
80105cbb:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105cc0:	e9 85 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105cc5:	6a 00                	push   $0x0
  pushl $252
80105cc7:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105ccc:	e9 79 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105cd1:	6a 00                	push   $0x0
  pushl $253
80105cd3:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105cd8:	e9 6d f1 ff ff       	jmp    80104e4a <alltraps>
...
80105cdd:	6a 00                	push   $0x0
  pushl $254
80105cdf:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105ce4:	e9 61 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105ce9:	6a 00                	push   $0x0
  pushl $255
80105ceb:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105cf0:	e9 55 f1 ff ff       	jmp    80104e4a <alltraps>
...
80105cf9:	56                   	push   %esi
80105cfa:	53                   	push   %ebx
80105cfb:	83 ec 0c             	sub    $0xc,%esp
80105cfe:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105d00:	c1 ea 16             	shr    $0x16,%edx
80105d03:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105d06:	8b 1f                	mov    (%edi),%ebx
80105d08:	f6 c3 01             	test   $0x1,%bl
80105d0b:	74 22                	je     80105d2f <walkpgdir+0x3a>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105d0d:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105d13:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80105d19:	c1 ee 0c             	shr    $0xc,%esi
80105d1c:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
80105d22:	8d 1c b3             	lea    (%ebx,%esi,4),%ebx
}
...
80105d2f:	85 c9                	test   %ecx,%ecx
80105d31:	74 2b                	je     80105d5e <walkpgdir+0x69>
80105d33:	e8 83 c3 ff ff       	call   801020bb <kalloc>
80105d38:	89 c3                	mov    %eax,%ebx
80105d3a:	85 c0                	test   %eax,%eax
80105d3c:	74 e7                	je     80105d25 <walkpgdir+0x30>
    memset(pgtab, 0, PGSIZE);
80105d3e:	83 ec 04             	sub    $0x4,%esp
80105d41:	68 00 10 00 00       	push   $0x1000
80105d46:	6a 00                	push   $0x0
80105d48:	50                   	push   %eax
80105d49:	e8 85 df ff ff       	call   80103cd3 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105d4e:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105d54:	83 c8 07             	or     $0x7,%eax
80105d57:	89 07                	mov    %eax,(%edi)
80105d59:	83 c4 10             	add    $0x10,%esp
80105d5c:	eb bb                	jmp    80105d19 <walkpgdir+0x24>
      return 0;
80105d5e:	bb 00 00 00 00       	mov    $0x0,%ebx
80105d63:	eb c0                	jmp    80105d25 <walkpgdir+0x30>
...
80105d71:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105d74:	89 d3                	mov    %edx,%ebx
80105d76:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105d7c:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105d80:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105d86:	b9 01 00 00 00       	mov    $0x1,%ecx
80105d8b:	89 da                	mov    %ebx,%edx
80105d8d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d90:	e8 60 ff ff ff       	call   80105cf5 <walkpgdir>
80105d95:	85 c0                	test   %eax,%eax
80105d97:	74 2e                	je     80105dc7 <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105d99:	f6 00 01             	testb  $0x1,(%eax)
80105d9c:	75 1c                	jne    80105dba <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105d9e:	89 f2                	mov    %esi,%edx
80105da0:	0b 55 0c             	or     0xc(%ebp),%edx
80105da3:	83 ca 01             	or     $0x1,%edx
80105da6:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105da8:	39 fb                	cmp    %edi,%ebx
80105daa:	74 28                	je     80105dd4 <mappages+0x6f>
      break;
    a += PGSIZE;
80105dac:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105db2:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105db8:	eb cc                	jmp    80105d86 <mappages+0x21>
      panic("remap");
80105dba:	83 ec 0c             	sub    $0xc,%esp
80105dbd:	68 98 6e 10 80       	push   $0x80106e98
80105dc2:	e8 81 a5 ff ff       	call   80100348 <panic>
      return -1;
...
80105dd9:	eb f1                	jmp    80105dcc <mappages+0x67>

80105ddb <seginit>:
{
80105ddb:	55                   	push   %ebp
80105ddc:	89 e5                	mov    %esp,%ebp
80105dde:	53                   	push   %ebx
80105ddf:	83 ec 14             	sub    $0x14,%esp
  c = &cpus[cpuid()];
80105de2:	e8 fa d3 ff ff       	call   801031e1 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105de7:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80105ded:	66 c7 80 f8 17 11 80 	movw   $0xffff,-0x7feee808(%eax)
80105df4:	ff ff 
80105df6:	66 c7 80 fa 17 11 80 	movw   $0x0,-0x7feee806(%eax)
80105dfd:	00 00 
80105dff:	c6 80 fc 17 11 80 00 	movb   $0x0,-0x7feee804(%eax)
80105e06:	0f b6 88 fd 17 11 80 	movzbl -0x7feee803(%eax),%ecx
80105e0d:	83 e1 f0             	and    $0xfffffff0,%ecx
80105e10:	83 c9 1a             	or     $0x1a,%ecx
80105e13:	83 e1 9f             	and    $0xffffff9f,%ecx
80105e16:	83 c9 80             	or     $0xffffff80,%ecx
80105e19:	88 88 fd 17 11 80    	mov    %cl,-0x7feee803(%eax)
80105e1f:	0f b6 88 fe 17 11 80 	movzbl -0x7feee802(%eax),%ecx
80105e26:	83 c9 0f             	or     $0xf,%ecx
80105e29:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e2c:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e2f:	88 88 fe 17 11 80    	mov    %cl,-0x7feee802(%eax)
80105e35:	c6 80 ff 17 11 80 00 	movb   $0x0,-0x7feee801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105e3c:	66 c7 80 00 18 11 80 	movw   $0xffff,-0x7feee800(%eax)
80105e43:	ff ff 
80105e45:	66 c7 80 02 18 11 80 	movw   $0x0,-0x7feee7fe(%eax)
80105e4c:	00 00 
80105e4e:	c6 80 04 18 11 80 00 	movb   $0x0,-0x7feee7fc(%eax)
80105e55:	0f b6 88 05 18 11 80 	movzbl -0x7feee7fb(%eax),%ecx
80105e5c:	83 e1 f0             	and    $0xfffffff0,%ecx
80105e5f:	83 c9 12             	or     $0x12,%ecx
80105e62:	83 e1 9f             	and    $0xffffff9f,%ecx
80105e65:	83 c9 80             	or     $0xffffff80,%ecx
80105e68:	88 88 05 18 11 80    	mov    %cl,-0x7feee7fb(%eax)
80105e6e:	0f b6 88 06 18 11 80 	movzbl -0x7feee7fa(%eax),%ecx
80105e75:	83 c9 0f             	or     $0xf,%ecx
80105e78:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e7b:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e7e:	88 88 06 18 11 80    	mov    %cl,-0x7feee7fa(%eax)
80105e84:	c6 80 07 18 11 80 00 	movb   $0x0,-0x7feee7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105e8b:	66 c7 80 08 18 11 80 	movw   $0xffff,-0x7feee7f8(%eax)
80105e92:	ff ff 
80105e94:	66 c7 80 0a 18 11 80 	movw   $0x0,-0x7feee7f6(%eax)
80105e9b:	00 00 
80105e9d:	c6 80 0c 18 11 80 00 	movb   $0x0,-0x7feee7f4(%eax)
80105ea4:	c6 80 0d 18 11 80 fa 	movb   $0xfa,-0x7feee7f3(%eax)
80105eab:	0f b6 88 0e 18 11 80 	movzbl -0x7feee7f2(%eax),%ecx
80105eb2:	83 c9 0f             	or     $0xf,%ecx
80105eb5:	83 e1 cf             	and    $0xffffffcf,%ecx
80105eb8:	83 c9 c0             	or     $0xffffffc0,%ecx
80105ebb:	88 88 0e 18 11 80    	mov    %cl,-0x7feee7f2(%eax)
80105ec1:	c6 80 0f 18 11 80 00 	movb   $0x0,-0x7feee7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80105ec8:	66 c7 80 10 18 11 80 	movw   $0xffff,-0x7feee7f0(%eax)
80105ecf:	ff ff 
80105ed1:	66 c7 80 12 18 11 80 	movw   $0x0,-0x7feee7ee(%eax)
80105ed8:	00 00 
80105eda:	c6 80 14 18 11 80 00 	movb   $0x0,-0x7feee7ec(%eax)
80105ee1:	c6 80 15 18 11 80 f2 	movb   $0xf2,-0x7feee7eb(%eax)
80105ee8:	0f b6 88 16 18 11 80 	movzbl -0x7feee7ea(%eax),%ecx
80105eef:	83 c9 0f             	or     $0xf,%ecx
80105ef2:	83 e1 cf             	and    $0xffffffcf,%ecx
80105ef5:	83 c9 c0             	or     $0xffffffc0,%ecx
80105ef8:	88 88 16 18 11 80    	mov    %cl,-0x7feee7ea(%eax)
80105efe:	c6 80 17 18 11 80 00 	movb   $0x0,-0x7feee7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80105f05:	05 f0 17 11 80       	add    $0x801117f0,%eax
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80105f0a:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
80105f10:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80105f14:	c1 e8 10             	shr    $0x10,%eax
80105f17:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80105f1b:	8d 45 f2             	lea    -0xe(%ebp),%eax
80105f1e:	0f 01 10             	lgdtl  (%eax)
}
...
80105f2a:	a1 a4 46 11 80       	mov    0x801146a4,%eax
80105f2f:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80105f3f:	83 ec 1c             	sub    $0x1c,%esp
80105f42:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80105f45:	85 f6                	test   %esi,%esi
80105f47:	0f 84 dd 00 00 00    	je     8010602a <switchuvm+0xf1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80105f4d:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80105f51:	0f 84 e0 00 00 00    	je     80106037 <switchuvm+0xfe>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80105f57:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80105f5b:	0f 84 e3 00 00 00    	je     80106044 <switchuvm+0x10b>
    panic("switchuvm: no pgdir");

  pushcli();
80105f61:	e8 e4 db ff ff       	call   80103b4a <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80105f66:	e8 1a d2 ff ff       	call   80103185 <mycpu>
80105f6b:	89 c3                	mov    %eax,%ebx
80105f6d:	e8 13 d2 ff ff       	call   80103185 <mycpu>
80105f72:	8d 78 08             	lea    0x8(%eax),%edi
80105f75:	e8 0b d2 ff ff       	call   80103185 <mycpu>
80105f7a:	83 c0 08             	add    $0x8,%eax
80105f7d:	c1 e8 10             	shr    $0x10,%eax
80105f80:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105f83:	e8 fd d1 ff ff       	call   80103185 <mycpu>
80105f88:	83 c0 08             	add    $0x8,%eax
80105f8b:	c1 e8 18             	shr    $0x18,%eax
80105f8e:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80105f95:	67 00 
80105f97:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80105f9e:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
80105fa2:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80105fa8:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80105faf:	83 e2 f0             	and    $0xfffffff0,%edx
80105fb2:	83 ca 19             	or     $0x19,%edx
80105fb5:	83 e2 9f             	and    $0xffffff9f,%edx
80105fb8:	83 ca 80             	or     $0xffffff80,%edx
80105fbb:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80105fc1:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80105fc8:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80105fce:	e8 b2 d1 ff ff       	call   80103185 <mycpu>
80105fd3:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80105fda:	83 e2 ef             	and    $0xffffffef,%edx
80105fdd:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80105fe3:	e8 9d d1 ff ff       	call   80103185 <mycpu>
80105fe8:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80105fee:	8b 5e 08             	mov    0x8(%esi),%ebx
80105ff1:	e8 8f d1 ff ff       	call   80103185 <mycpu>
80105ff6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80105ffc:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80105fff:	e8 81 d1 ff ff       	call   80103185 <mycpu>
80106004:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
8010600a:	b8 28 00 00 00       	mov    $0x28,%eax
8010600f:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106012:	8b 46 04             	mov    0x4(%esi),%eax
80106015:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
8010601a:	0f 22 d8             	mov    %eax,%cr3
  popcli();
8010601d:	e8 65 db ff ff       	call   80103b87 <popcli>
}
...
8010602d:	68 9e 6e 10 80       	push   $0x80106e9e
80106032:	e8 11 a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
80106037:	83 ec 0c             	sub    $0xc,%esp
8010603a:	68 b4 6e 10 80       	push   $0x80106eb4
8010603f:	e8 04 a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
80106044:	83 ec 0c             	sub    $0xc,%esp
80106047:	68 c9 6e 10 80       	push   $0x80106ec9
8010604c:	e8 f7 a2 ff ff       	call   80100348 <panic>
...
80106056:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
80106059:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010605f:	77 4c                	ja     801060ad <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
80106061:	e8 55 c0 ff ff       	call   801020bb <kalloc>
80106066:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106068:	83 ec 04             	sub    $0x4,%esp
8010606b:	68 00 10 00 00       	push   $0x1000
80106070:	6a 00                	push   $0x0
80106072:	50                   	push   %eax
80106073:	e8 5b dc ff ff       	call   80103cd3 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106078:	83 c4 08             	add    $0x8,%esp
8010607b:	6a 06                	push   $0x6
8010607d:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106083:	50                   	push   %eax
80106084:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106089:	ba 00 00 00 00       	mov    $0x0,%edx
8010608e:	8b 45 08             	mov    0x8(%ebp),%eax
80106091:	e8 cf fc ff ff       	call   80105d65 <mappages>
  memmove(mem, init, sz);
80106096:	83 c4 0c             	add    $0xc,%esp
80106099:	56                   	push   %esi
8010609a:	ff 75 0c             	pushl  0xc(%ebp)
8010609d:	53                   	push   %ebx
8010609e:	e8 ab dc ff ff       	call   80103d4e <memmove>
}
801060a3:	83 c4 10             	add    $0x10,%esp
801060a6:	8d 65 f8             	lea    -0x8(%ebp),%esp
801060a9:	5b                   	pop    %ebx
801060aa:	5e                   	pop    %esi
801060ab:	5d                   	pop    %ebp
801060ac:	c3                   	ret    
...
801060b0:	68 dd 6e 10 80       	push   $0x80106edd
801060b5:	e8 8e a2 ff ff       	call   80100348 <panic>
...
801060c3:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801060c6:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
801060cd:	75 07                	jne    801060d6 <loaduvm+0x1c>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801060cf:	bb 00 00 00 00       	mov    $0x0,%ebx
801060d4:	eb 3c                	jmp    80106112 <loaduvm+0x58>
    panic("loaduvm: addr must be page aligned");
801060d6:	83 ec 0c             	sub    $0xc,%esp
801060d9:	68 98 6f 10 80       	push   $0x80106f98
801060de:	e8 65 a2 ff ff       	call   80100348 <panic>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801060e3:	83 ec 0c             	sub    $0xc,%esp
801060e6:	68 f7 6e 10 80       	push   $0x80106ef7
801060eb:	e8 58 a2 ff ff       	call   80100348 <panic>
    pa = PTE_ADDR(*pte);
    if(sz - i < PGSIZE)
      n = sz - i;
    else
...
801060f6:	89 da                	mov    %ebx,%edx
801060f8:	03 55 14             	add    0x14(%ebp),%edx
801060fb:	52                   	push   %edx
801060fc:	50                   	push   %eax
801060fd:	ff 75 10             	pushl  0x10(%ebp)
80106100:	e8 6e b6 ff ff       	call   80101773 <readi>
80106105:	83 c4 10             	add    $0x10,%esp
80106108:	39 f0                	cmp    %esi,%eax
8010610a:	75 47                	jne    80106153 <loaduvm+0x99>
  for(i = 0; i < sz; i += PGSIZE){
8010610c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106112:	39 fb                	cmp    %edi,%ebx
80106114:	73 30                	jae    80106146 <loaduvm+0x8c>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106116:	89 da                	mov    %ebx,%edx
80106118:	03 55 0c             	add    0xc(%ebp),%edx
8010611b:	b9 00 00 00 00       	mov    $0x0,%ecx
80106120:	8b 45 08             	mov    0x8(%ebp),%eax
80106123:	e8 cd fb ff ff       	call   80105cf5 <walkpgdir>
80106128:	85 c0                	test   %eax,%eax
8010612a:	74 b7                	je     801060e3 <loaduvm+0x29>
    pa = PTE_ADDR(*pte);
8010612c:	8b 00                	mov    (%eax),%eax
8010612e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106133:	89 fe                	mov    %edi,%esi
80106135:	29 de                	sub    %ebx,%esi
80106137:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010613d:	76 b1                	jbe    801060f0 <loaduvm+0x36>
      n = PGSIZE;
8010613f:	be 00 10 00 00       	mov    $0x1000,%esi
80106144:	eb aa                	jmp    801060f0 <loaduvm+0x36>
      return -1;
  }
  return 0;
80106146:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010614b:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010614e:	5b                   	pop    %ebx
8010614f:	5e                   	pop    %esi
80106150:	5f                   	pop    %edi
80106151:	5d                   	pop    %ebp
...
80106158:	eb f1                	jmp    8010614b <loaduvm+0x91>
...
80106163:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80106166:	39 7d 10             	cmp    %edi,0x10(%ebp)
80106169:	73 11                	jae    8010617c <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
8010616b:	8b 45 10             	mov    0x10(%ebp),%eax
8010616e:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106174:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010617a:	eb 19                	jmp    80106195 <deallocuvm+0x3b>
    return oldsz;
8010617c:	89 f8                	mov    %edi,%eax
8010617e:	eb 64                	jmp    801061e4 <deallocuvm+0x8a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106180:	c1 eb 16             	shr    $0x16,%ebx
80106183:	83 c3 01             	add    $0x1,%ebx
80106186:	c1 e3 16             	shl    $0x16,%ebx
80106189:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010618f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106195:	39 fb                	cmp    %edi,%ebx
80106197:	73 48                	jae    801061e1 <deallocuvm+0x87>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106199:	b9 00 00 00 00       	mov    $0x0,%ecx
8010619e:	89 da                	mov    %ebx,%edx
801061a0:	8b 45 08             	mov    0x8(%ebp),%eax
801061a3:	e8 4d fb ff ff       	call   80105cf5 <walkpgdir>
801061a8:	89 c6                	mov    %eax,%esi
    if(!pte)
801061aa:	85 c0                	test   %eax,%eax
801061ac:	74 d2                	je     80106180 <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
801061ae:	8b 00                	mov    (%eax),%eax
801061b0:	a8 01                	test   $0x1,%al
801061b2:	74 db                	je     8010618f <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
801061b4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801061b9:	74 19                	je     801061d4 <deallocuvm+0x7a>
        panic("kfree");
      char *v = P2V(pa);
...
801061c4:	e8 db bd ff ff       	call   80101fa4 <kfree>
      *pte = 0;
801061c9:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
801061cf:	83 c4 10             	add    $0x10,%esp
801061d2:	eb bb                	jmp    8010618f <deallocuvm+0x35>
        panic("kfree");
801061d4:	83 ec 0c             	sub    $0xc,%esp
801061d7:	68 06 68 10 80       	push   $0x80106806
801061dc:	e8 67 a1 ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
801061e1:	8b 45 10             	mov    0x10(%ebp),%eax
}
801061e4:	8d 65 f4             	lea    -0xc(%ebp),%esp
801061e7:	5b                   	pop    %ebx
801061e8:	5e                   	pop    %esi
801061e9:	5f                   	pop    %edi
801061ea:	5d                   	pop    %ebp
...
801061f5:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
801061f8:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801061fb:	85 ff                	test   %edi,%edi
801061fd:	0f 88 c1 00 00 00    	js     801062c4 <allocuvm+0xd8>
  if(newsz < oldsz)
80106203:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106206:	72 5c                	jb     80106264 <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
80106208:	8b 45 0c             	mov    0xc(%ebp),%eax
8010620b:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106211:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106217:	39 fb                	cmp    %edi,%ebx
80106219:	0f 83 ac 00 00 00    	jae    801062cb <allocuvm+0xdf>
    mem = kalloc();
8010621f:	e8 97 be ff ff       	call   801020bb <kalloc>
80106224:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106226:	85 c0                	test   %eax,%eax
80106228:	74 42                	je     8010626c <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
8010622a:	83 ec 04             	sub    $0x4,%esp
8010622d:	68 00 10 00 00       	push   $0x1000
80106232:	6a 00                	push   $0x0
80106234:	50                   	push   %eax
80106235:	e8 99 da ff ff       	call   80103cd3 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
8010623a:	83 c4 08             	add    $0x8,%esp
8010623d:	6a 06                	push   $0x6
8010623f:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106245:	50                   	push   %eax
80106246:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010624b:	89 da                	mov    %ebx,%edx
8010624d:	8b 45 08             	mov    0x8(%ebp),%eax
80106250:	e8 10 fb ff ff       	call   80105d65 <mappages>
80106255:	83 c4 10             	add    $0x10,%esp
80106258:	85 c0                	test   %eax,%eax
8010625a:	78 38                	js     80106294 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
8010625c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106262:	eb b3                	jmp    80106217 <allocuvm+0x2b>
    return oldsz;
80106264:	8b 45 0c             	mov    0xc(%ebp),%eax
80106267:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010626a:	eb 5f                	jmp    801062cb <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
8010626c:	83 ec 0c             	sub    $0xc,%esp
8010626f:	68 15 6f 10 80       	push   $0x80106f15
80106274:	e8 92 a3 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106279:	83 c4 0c             	add    $0xc,%esp
8010627c:	ff 75 0c             	pushl  0xc(%ebp)
8010627f:	57                   	push   %edi
80106280:	ff 75 08             	pushl  0x8(%ebp)
80106283:	e8 d2 fe ff ff       	call   8010615a <deallocuvm>
      return 0;
80106288:	83 c4 10             	add    $0x10,%esp
8010628b:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106292:	eb 37                	jmp    801062cb <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
80106294:	83 ec 0c             	sub    $0xc,%esp
80106297:	68 2d 6f 10 80       	push   $0x80106f2d
8010629c:	e8 6a a3 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801062a1:	83 c4 0c             	add    $0xc,%esp
801062a4:	ff 75 0c             	pushl  0xc(%ebp)
801062a7:	57                   	push   %edi
801062a8:	ff 75 08             	pushl  0x8(%ebp)
801062ab:	e8 aa fe ff ff       	call   8010615a <deallocuvm>
      kfree(mem);
801062b0:	89 34 24             	mov    %esi,(%esp)
801062b3:	e8 ec bc ff ff       	call   80101fa4 <kfree>
      return 0;
801062b8:	83 c4 10             	add    $0x10,%esp
801062bb:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801062c2:	eb 07                	jmp    801062cb <allocuvm+0xdf>
    return 0;
801062c4:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
801062db:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
801062de:	85 f6                	test   %esi,%esi
801062e0:	74 1a                	je     801062fc <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
801062e2:	83 ec 04             	sub    $0x4,%esp
801062e5:	6a 00                	push   $0x0
801062e7:	68 00 00 00 80       	push   $0x80000000
801062ec:	56                   	push   %esi
801062ed:	e8 68 fe ff ff       	call   8010615a <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801062f2:	83 c4 10             	add    $0x10,%esp
801062f5:	bb 00 00 00 00       	mov    $0x0,%ebx
801062fa:	eb 10                	jmp    8010630c <freevm+0x36>
    panic("freevm: no pgdir");
801062fc:	83 ec 0c             	sub    $0xc,%esp
801062ff:	68 49 6f 10 80       	push   $0x80106f49
80106304:	e8 3f a0 ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
80106309:	83 c3 01             	add    $0x1,%ebx
8010630c:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
80106312:	77 1f                	ja     80106333 <freevm+0x5d>
    if(pgdir[i] & PTE_P){
80106314:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
80106317:	a8 01                	test   $0x1,%al
80106319:	74 ee                	je     80106309 <freevm+0x33>
      char * v = P2V(PTE_ADDR(pgdir[i]));
8010631b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106320:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
80106325:	83 ec 0c             	sub    $0xc,%esp
80106328:	50                   	push   %eax
80106329:	e8 76 bc ff ff       	call   80101fa4 <kfree>
8010632e:	83 c4 10             	add    $0x10,%esp
80106331:	eb d6                	jmp    80106309 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
...
8010634b:	e8 6b bd ff ff       	call   801020bb <kalloc>
80106350:	89 c6                	mov    %eax,%esi
80106352:	85 c0                	test   %eax,%eax
80106354:	74 55                	je     801063ab <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
80106356:	83 ec 04             	sub    $0x4,%esp
80106359:	68 00 10 00 00       	push   $0x1000
8010635e:	6a 00                	push   $0x0
80106360:	50                   	push   %eax
80106361:	e8 6d d9 ff ff       	call   80103cd3 <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106366:	83 c4 10             	add    $0x10,%esp
80106369:	bb 20 94 10 80       	mov    $0x80109420,%ebx
8010636e:	81 fb 60 94 10 80    	cmp    $0x80109460,%ebx
80106374:	73 35                	jae    801063ab <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
80106376:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106379:	8b 4b 08             	mov    0x8(%ebx),%ecx
8010637c:	29 c1                	sub    %eax,%ecx
8010637e:	83 ec 08             	sub    $0x8,%esp
80106381:	ff 73 0c             	pushl  0xc(%ebx)
80106384:	50                   	push   %eax
80106385:	8b 13                	mov    (%ebx),%edx
80106387:	89 f0                	mov    %esi,%eax
80106389:	e8 d7 f9 ff ff       	call   80105d65 <mappages>
8010638e:	83 c4 10             	add    $0x10,%esp
80106391:	85 c0                	test   %eax,%eax
80106393:	78 05                	js     8010639a <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106395:	83 c3 10             	add    $0x10,%ebx
80106398:	eb d4                	jmp    8010636e <setupkvm+0x28>
      freevm(pgdir);
8010639a:	83 ec 0c             	sub    $0xc,%esp
8010639d:	56                   	push   %esi
8010639e:	e8 33 ff ff ff       	call   801062d6 <freevm>
      return 0;
801063a3:	83 c4 10             	add    $0x10,%esp
801063a6:	be 00 00 00 00       	mov    $0x0,%esi
}
801063ab:	89 f0                	mov    %esi,%eax
801063ad:	8d 65 f8             	lea    -0x8(%ebp),%esp
801063b0:	5b                   	pop    %ebx
801063b1:	5e                   	pop    %esi
801063b2:	5d                   	pop    %ebp
801063b3:	c3                   	ret    
...
801063b7:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801063ba:	e8 87 ff ff ff       	call   80106346 <setupkvm>
801063bf:	a3 a4 46 11 80       	mov    %eax,0x801146a4
  switchkvm();
801063c4:	e8 5e fb ff ff       	call   80105f27 <switchkvm>
}
801063c9:	c9                   	leave  
801063ca:	c3                   	ret    
...
801063d1:	b9 00 00 00 00       	mov    $0x0,%ecx
801063d6:	8b 55 0c             	mov    0xc(%ebp),%edx
801063d9:	8b 45 08             	mov    0x8(%ebp),%eax
801063dc:	e8 14 f9 ff ff       	call   80105cf5 <walkpgdir>
  if(pte == 0)
801063e1:	85 c0                	test   %eax,%eax
801063e3:	74 05                	je     801063ea <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
801063e5:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801063e8:	c9                   	leave  
801063e9:	c3                   	ret    
    panic("clearpteu");
801063ea:	83 ec 0c             	sub    $0xc,%esp
801063ed:	68 5a 6f 10 80       	push   $0x80106f5a
801063f2:	e8 51 9f ff ff       	call   80100348 <panic>
...
801063fd:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80106400:	e8 41 ff ff ff       	call   80106346 <setupkvm>
80106405:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106408:	85 c0                	test   %eax,%eax
8010640a:	0f 84 c4 00 00 00    	je     801064d4 <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106410:	bf 00 00 00 00       	mov    $0x0,%edi
80106415:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106418:	0f 83 b6 00 00 00    	jae    801064d4 <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010641e:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106421:	b9 00 00 00 00       	mov    $0x0,%ecx
80106426:	89 fa                	mov    %edi,%edx
80106428:	8b 45 08             	mov    0x8(%ebp),%eax
8010642b:	e8 c5 f8 ff ff       	call   80105cf5 <walkpgdir>
80106430:	85 c0                	test   %eax,%eax
80106432:	74 65                	je     80106499 <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106434:	8b 00                	mov    (%eax),%eax
80106436:	a8 01                	test   $0x1,%al
80106438:	74 6c                	je     801064a6 <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
8010643a:	89 c6                	mov    %eax,%esi
8010643c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
80106442:	25 ff 0f 00 00       	and    $0xfff,%eax
80106447:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
8010644a:	e8 6c bc ff ff       	call   801020bb <kalloc>
8010644f:	89 c3                	mov    %eax,%ebx
80106451:	85 c0                	test   %eax,%eax
80106453:	74 6a                	je     801064bf <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106455:	81 c6 00 00 00 80    	add    $0x80000000,%esi
8010645b:	83 ec 04             	sub    $0x4,%esp
8010645e:	68 00 10 00 00       	push   $0x1000
80106463:	56                   	push   %esi
80106464:	50                   	push   %eax
80106465:	e8 e4 d8 ff ff       	call   80103d4e <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
8010646a:	83 c4 08             	add    $0x8,%esp
8010646d:	ff 75 e0             	pushl  -0x20(%ebp)
80106470:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106476:	50                   	push   %eax
80106477:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010647c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010647f:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106482:	e8 de f8 ff ff       	call   80105d65 <mappages>
80106487:	83 c4 10             	add    $0x10,%esp
8010648a:	85 c0                	test   %eax,%eax
8010648c:	78 25                	js     801064b3 <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
8010648e:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106494:	e9 7c ff ff ff       	jmp    80106415 <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
80106499:	83 ec 0c             	sub    $0xc,%esp
8010649c:	68 64 6f 10 80       	push   $0x80106f64
801064a1:	e8 a2 9e ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
801064a6:	83 ec 0c             	sub    $0xc,%esp
801064a9:	68 7e 6f 10 80       	push   $0x80106f7e
801064ae:	e8 95 9e ff ff       	call   80100348 <panic>
      kfree(mem);
801064b3:	83 ec 0c             	sub    $0xc,%esp
801064b6:	53                   	push   %ebx
801064b7:	e8 e8 ba ff ff       	call   80101fa4 <kfree>
      goto bad;
...
801064c2:	ff 75 dc             	pushl  -0x24(%ebp)
801064c5:	e8 0c fe ff ff       	call   801062d6 <freevm>
  return 0;
...
801064f0:	e8 00 f8 ff ff       	call   80105cf5 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106532:	ff 75 10             	pushl  0x10(%ebp)
80106535:	50                   	push   %eax
80106536:	e8 13 d8 ff ff       	call   80103d4e <memmove>
    len -= n;
...
8010655d:	ff 75 08             	pushl  0x8(%ebp)
