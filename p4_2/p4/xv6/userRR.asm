...
int main(int argc, char *argv[])
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
     setpri(getpid(), 0);
  11:	e8 4a 02 00 00       	call   260 <getpid>
  16:	83 ec 08             	sub    $0x8,%esp
  19:	6a 00                	push   $0x0
  1b:	50                   	push   %eax
  1c:	e8 5f 02 00 00       	call   280 <setpri>
     getpri(getpid());
  21:	e8 3a 02 00 00       	call   260 <getpid>
  26:	89 04 24             	mov    %eax,(%esp)
  29:	e8 5a 02 00 00       	call   288 <getpri>
     fork2(0);
  2e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  35:	e8 56 02 00 00       	call   290 <fork2>
     getpinfo(NULL);
  3a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  41:	e8 52 02 00 00       	call   298 <getpinfo>
    return 0;
}
  46:	b8 00 00 00 00       	mov    $0x0,%eax
  4b:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  4e:	c9                   	leave  
...
strcpy(char *s, const char *t)
{
  ...
  5f:	0f b6 19             	movzbl (%ecx),%ebx
  62:	88 1a                	mov    %bl,(%edx)
  64:	8d 52 01             	lea    0x1(%edx),%edx
  67:	8d 49 01             	lea    0x1(%ecx),%ecx
  6a:	84 db                	test   %bl,%bl
  6c:	75 f1                	jne    5f <strcpy+0xc>
    ;
  return os;
}
  6e:	5b                   	pop    %ebx
...
strlen(const char *s)
{
  ...
  a9:	80 3c 11 00          	cmpb   $0x0,(%ecx,%edx,1)
  ad:	75 f5                	jne    a4 <strlen+0xd>
    ;
  return n;
}
  af:	5d                   	pop    %ebp
...
strchr(const char *s, char c)
{
  ...
  d5:	84 d2                	test   %dl,%dl
  d7:	74 09                	je     e2 <strchr+0x1a>
    if(*s == c)
  d9:	38 ca                	cmp    %cl,%dl
  db:	74 0a                	je     e7 <strchr+0x1f>
  for(; *s; s++)
  dd:	83 c0 01             	add    $0x1,%eax
  e0:	eb f0                	jmp    d2 <strchr+0xa>
      return (char*)s;
  return 0;
...
gets(char *buf, int max)
{
  ...
  fa:	8d 73 01             	lea    0x1(%ebx),%esi
  fd:	3b 75 0c             	cmp    0xc(%ebp),%esi
 100:	7d 2e                	jge    130 <gets+0x47>
    cc = read(0, &c, 1);
 ...
 10a:	50                   	push   %eax
 10b:	6a 00                	push   $0x0
 10d:	e8 e6 00 00 00       	call   1f8 <read>
    if(cc < 1)
 112:	83 c4 10             	add    $0x10,%esp
 115:	85 c0                	test   %eax,%eax
 117:	7e 17                	jle    130 <gets+0x47>
      break;
    buf[i++] = c;
 119:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
 11d:	88 04 1f             	mov    %al,(%edi,%ebx,1)
    if(c == '\n' || c == '\r')
 120:	3c 0a                	cmp    $0xa,%al
 122:	0f 94 c2             	sete   %dl
 125:	3c 0d                	cmp    $0xd,%al
 127:	0f 94 c0             	sete   %al
    buf[i++] = c;
 12a:	89 f3                	mov    %esi,%ebx
    if(c == '\n' || c == '\r')
 12c:	08 c2                	or     %al,%dl
 12e:	74 ca                	je     fa <gets+0x11>
      break;
  }
  buf[i] = '\0';
 130:	c6 04 1f 00          	movb   $0x0,(%edi,%ebx,1)
  return buf;
}
...
stat(const char *n, struct stat *st)
{
 ...
 14b:	e8 d0 00 00 00       	call   220 <open>
  if(fd < 0)
 ...
 15f:	50                   	push   %eax
 160:	e8 d3 00 00 00       	call   238 <fstat>
 165:	89 c6                	mov    %eax,%esi
  close(fd);
 167:	89 1c 24             	mov    %ebx,(%esp)
 16a:	e8 99 00 00 00       	call   208 <close>
  return r;
...
atoi(const char *s)
{
 ...
 189:	b8 00 00 00 00       	mov    $0x0,%eax
  while('0' <= *s && *s <= '9')
 18e:	eb 10                	jmp    1a0 <atoi+0x1e>
    n = n*10 + *s++ - '0';
 190:	8d 1c 80             	lea    (%eax,%eax,4),%ebx
 193:	8d 04 1b             	lea    (%ebx,%ebx,1),%eax
 196:	83 c1 01             	add    $0x1,%ecx
 199:	0f be d2             	movsbl %dl,%edx
 19c:	8d 44 02 d0          	lea    -0x30(%edx,%eax,1),%eax
  while('0' <= *s && *s <= '9')
 1a0:	0f b6 11             	movzbl (%ecx),%edx
 1a3:	8d 5a d0             	lea    -0x30(%edx),%ebx
 1a6:	80 fb 09             	cmp    $0x9,%bl
 1a9:	76 e5                	jbe    190 <atoi+0xe>
  return n;
}
 1ab:	5b                   	pop    %ebx
 1ac:	5d                   	pop    %ebp
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 1bc:	89 c1                	mov    %eax,%ecx
  src = vsrc;
  while(n-- > 0)
 1be:	eb 0d                	jmp    1cd <memmove+0x1f>
    *dst++ = *src++;
 1c0:	0f b6 13             	movzbl (%ebx),%edx
 1c3:	88 11                	mov    %dl,(%ecx)
 1c5:	8d 5b 01             	lea    0x1(%ebx),%ebx
 1c8:	8d 49 01             	lea    0x1(%ecx),%ecx
  while(n-- > 0)
 1cb:	89 f2                	mov    %esi,%edx
 1cd:	8d 72 ff             	lea    -0x1(%edx),%esi
 1d0:	85 d2                	test   %edx,%edx
 1d2:	7f ec                	jg     1c0 <memmove+0x12>
  return vdst;
}
 1d4:	5b                   	pop    %ebx
 1d5:	5e                   	pop    %esi
...
000001e0 <exit>:
SYSCALL(exit)
 1e0:	b8 02 00 00 00       	mov    $0x2,%eax
 1e5:	cd 40                	int    $0x40
 1e7:	c3                   	ret    

000001e8 <wait>:
SYSCALL(wait)
 1e8:	b8 03 00 00 00       	mov    $0x3,%eax
 1ed:	cd 40                	int    $0x40
 1ef:	c3                   	ret    

000001f0 <pipe>:
SYSCALL(pipe)
 1f0:	b8 04 00 00 00       	mov    $0x4,%eax
 1f5:	cd 40                	int    $0x40
 1f7:	c3                   	ret    

000001f8 <read>:
SYSCALL(read)
 1f8:	b8 05 00 00 00       	mov    $0x5,%eax
 1fd:	cd 40                	int    $0x40
 1ff:	c3                   	ret    

00000200 <write>:
SYSCALL(write)
 200:	b8 10 00 00 00       	mov    $0x10,%eax
 205:	cd 40                	int    $0x40
 207:	c3                   	ret    

00000208 <close>:
SYSCALL(close)
 208:	b8 15 00 00 00       	mov    $0x15,%eax
 20d:	cd 40                	int    $0x40
 20f:	c3                   	ret    

00000210 <kill>:
SYSCALL(kill)
 210:	b8 06 00 00 00       	mov    $0x6,%eax
 215:	cd 40                	int    $0x40
 217:	c3                   	ret    

00000218 <exec>:
SYSCALL(exec)
 218:	b8 07 00 00 00       	mov    $0x7,%eax
 21d:	cd 40                	int    $0x40
 21f:	c3                   	ret    

00000220 <open>:
SYSCALL(open)
 220:	b8 0f 00 00 00       	mov    $0xf,%eax
 225:	cd 40                	int    $0x40
 227:	c3                   	ret    
...
00000230 <unlink>:
SYSCALL(unlink)
 230:	b8 12 00 00 00       	mov    $0x12,%eax
 235:	cd 40                	int    $0x40
 237:	c3                   	ret    

00000238 <fstat>:
SYSCALL(fstat)
 238:	b8 08 00 00 00       	mov    $0x8,%eax
 23d:	cd 40                	int    $0x40
 23f:	c3                   	ret    

00000240 <link>:
SYSCALL(link)
 240:	b8 13 00 00 00       	mov    $0x13,%eax
 245:	cd 40                	int    $0x40
 247:	c3                   	ret    

00000248 <mkdir>:
SYSCALL(mkdir)
 248:	b8 14 00 00 00       	mov    $0x14,%eax
 24d:	cd 40                	int    $0x40
 24f:	c3                   	ret    

00000250 <chdir>:
SYSCALL(chdir)
 250:	b8 09 00 00 00       	mov    $0x9,%eax
 255:	cd 40                	int    $0x40
 257:	c3                   	ret    

00000258 <dup>:
SYSCALL(dup)
 258:	b8 0a 00 00 00       	mov    $0xa,%eax
 25d:	cd 40                	int    $0x40
 25f:	c3                   	ret    

00000260 <getpid>:
SYSCALL(getpid)
 260:	b8 0b 00 00 00       	mov    $0xb,%eax
 265:	cd 40                	int    $0x40
 267:	c3                   	ret    

00000268 <sbrk>:
SYSCALL(sbrk)
 268:	b8 0c 00 00 00       	mov    $0xc,%eax
 26d:	cd 40                	int    $0x40
 26f:	c3                   	ret    

00000270 <sleep>:
SYSCALL(sleep)
 270:	b8 0d 00 00 00       	mov    $0xd,%eax
 275:	cd 40                	int    $0x40
 277:	c3                   	ret    

00000278 <uptime>:
SYSCALL(uptime)
 278:	b8 0e 00 00 00       	mov    $0xe,%eax
 27d:	cd 40                	int    $0x40
 27f:	c3                   	ret    

00000280 <setpri>:
SYSCALL(setpri)
 280:	b8 16 00 00 00       	mov    $0x16,%eax
 285:	cd 40                	int    $0x40
 287:	c3                   	ret    

00000288 <getpri>:
SYSCALL(getpri)
 288:	b8 17 00 00 00       	mov    $0x17,%eax
 28d:	cd 40                	int    $0x40
 28f:	c3                   	ret    
...
00000298 <getpinfo>:
SYSCALL(getpinfo)
 298:	b8 19 00 00 00       	mov    $0x19,%eax
 29d:	cd 40                	int    $0x40
 29f:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 2ae:	52                   	push   %edx
 2af:	50                   	push   %eax
 2b0:	e8 4b ff ff ff       	call   200 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 2fe:	0f b6 92 fc 05 00 00 	movzbl 0x5fc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 43a:	75 28                	jne    464 <printf+0x12a>
          s = "(null)";
 43c:	be f4 05 00 00       	mov    $0x5f4,%esi
...
free(void *ap)
{
 ...
 4af:	a1 9c 08 00 00       	mov    0x89c,%eax
 ...
 4eb:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4ed:	a3 9c 08 00 00       	mov    %eax,0x89c
}
 4f2:	5b                   	pop    %ebx
 4f3:	5e                   	pop    %esi
 4f4:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 532:	50                   	push   %eax
 533:	e8 30 fd ff ff       	call   268 <sbrk>
  if(p == (char*)-1)
 ...
 54a:	e8 54 ff ff ff       	call   4a3 <free>
  return freep;
 54f:	a1 9c 08 00 00       	mov    0x89c,%eax
...
malloc(uint nbytes)
{
 ...
 573:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 576:	8b 0d 9c 08 00 00    	mov    0x89c,%ecx
 ...
 582:	eb 4d                	jmp    5d1 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 584:	c7 05 9c 08 00 00 a0 	movl   $0x8a0,0x89c
 58b:	08 00 00 
 58e:	c7 05 a0 08 00 00 a0 	movl   $0x8a0,0x8a0
 595:	08 00 00 
    base.s.size = 0;
 598:	c7 05 a4 08 00 00 00 	movl   $0x0,0x8a4
 59f:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5a2:	b9 a0 08 00 00       	mov    $0x8a0,%ecx
 ...
 5b5:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5b8:	89 0d 9c 08 00 00    	mov    %ecx,0x89c
      return (void*)(p + 1);
 ...
 5d6:	73 d1                	jae    5a9 <malloc+0x46>
    if(p == freep)
 5d8:	39 05 9c 08 00 00    	cmp    %eax,0x89c
